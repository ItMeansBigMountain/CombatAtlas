...
async function capture() {
  ...
  await page1.screenshot({ path: '/opt/data/HeRmEz/projects/CombatAtlas/preview-evidence/prod-desktop-clean.png', fullPage: true });
  await page1.close();
  ...
  await page2.screenshot({ path: '/opt/data/HeRmEz/projects/CombatAtlas/preview-evidence/prod-desktop-photos.png', fullPage: true });
  await page2.close();
  ...
  await page3.screenshot({ path: '/opt/data/HeRmEz/projects/CombatAtlas/preview-evidence/prod-iphone-photos.png', fullPage: true });
  await page3.close();
