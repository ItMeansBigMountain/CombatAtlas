...
projects/osrs-plugins/
  in-progress/CompetitionOverlay/                 # RuneLite plugin only / Plugin Hub-facing
  services/
    clan-war-board-service/                       # separate backend/service project
      api/                                        # Azure Functions API
      web/                                        # optional Static Web Apps frontend
      infra/                                      # Bicep/Terraform for this service only
      docs/
...
Use Bicep inside the service repo:

```text
services/clan-war-board-service/infra/
  main.bicep
  parameters.dev.json
