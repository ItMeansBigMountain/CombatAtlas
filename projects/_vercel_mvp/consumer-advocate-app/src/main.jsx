...
import './styles.css';
const summary = "## README.md\n# Consumer Advocate App\n\nApp to simplify terms and conditions and produce consumer-friendly highlights, possibly including video summaries.\n\n## Status\n\nBacklog imported on 2026-05-03. Implementation has not started in this scaffold.\n\n## Environment\n\nLocal configuration should come from `.env`. Do not commit real secrets. Keep committed examples in `.env.example`.\n\n\n## PROJECT.md\n# Project Plan - Consumer Advocate App\n\n- **Created:** 2026-05-03\n- **Source:** User merged todo lists from 2026-05-03\n- **Project path:** `C:\\Users\\faree\\Desktop\\OpEnCLAw\\consumer-advocate-app`\n- **Primary next action:** See `C:\\Users\\faree\\.openclaw\\workspace\\work-queue.md`.\n\n## Notes\n\nApp to simplify terms and conditions and produce consumer-friendly highlights, possibly including video summaries.\ncatalogue should show different brands and products that you can search with summeries of what their terms and conditions are. including anything that sticks out the ordinary.";
function App() {
  return <main className="shell">
    <section className="hero">
      <p className="eyebrow">HeRmEz live project review</p>
      <h1>Consumer Advocate App</h1>
      <p className="lede">Terms, privacy, and subscription-risk analyzer for everyday consumers.</p>
