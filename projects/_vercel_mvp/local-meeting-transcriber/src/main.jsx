...
import './styles.css';
const summary = "local-meeting-transcriber project demo/review shell.";
function App() {
  return <main className="shell">
    <section className="hero">
      <p className="eyebrow">HeRmEz live project review</p>
      <h1>Local Meeting Transcriber</h1>
      <p className="lede">Live review shell for local-meeting-transcriber.</p>
