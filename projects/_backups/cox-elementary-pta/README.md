...
This project-backup directory contains a Git bundle backup of the Cox Elementary PTA website project.
...
- Backup file: `projects/_backups/cox-elementary-pta/cox-elementary-pta.bundle`

## Restore/check commands

```bash
# Inspect bundle
git bundle verify projects/_backups/cox-elementary-pta/cox-elementary-pta.bundle

# Restore into a fresh folder
git clone projects/_backups/cox-elementary-pta/cox-elementary-pta.bundle restored-cox-elementary-pta
