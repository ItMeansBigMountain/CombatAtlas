...
§
Google/YT: Workspace R/W incl affan; Classical Echos downloader login. Before OAuth URLs, audit maintained projects for complete per-account scopes, separate credential classes, regenerate states, verify scopes.
§
