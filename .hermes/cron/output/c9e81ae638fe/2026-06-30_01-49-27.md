...
```
{
  "workspace": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260630-014517-qwen-3-6-27b-is-the-sweet-spot-for-local-development",
  "video": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260630-014517-qwen-3-6-27b-is-the-sweet-spot-for-local-development/final.mp4",
  "uploaded": false
}
```
...
- Status: `ok_uploaded`
- Topic: Cisco CUCM flaw, KDDI 14M data leak, Scattered Spider pleas
- Hook/on-screen open: “YOU MISSED THIS”
- Upload: https://youtu.be/oxKpoa-fp9w
- Video ID: `oxKpoa-fp9w`
- Privacy: public
- Workspace: `/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260630-014610-cisco-cucm-flaw-kddi-14m-data-leak-scattered-spider-hackers-plead`
- Final MP4: uploaded, then safely deleted after verified YouTube `video_id`
- Preserved: `result.json`, `script.json`, `voice_manifest.json`, `visual_manifest.json`, `source_email.json`
- Source email: trashed only after upload verification
- TTS: Google TTS
- ffprobe: vertical `1080x1920`, audio present, duration `95.16s`
- py_compile: passed for `newsletter_batch_upload.py` and `run_trend_video.py`
- Metrics monitor: ok, OAuth metrics active, 121 stats fetched
- Upload log verified: `UPLOADS/newsletter_youtube_uploads.jsonl`
- Blocker: none

Note: the pre-run generated trend video was not uploaded and probed as horizontal `1920x1080`, so I used the newsletter batch path as requested.
