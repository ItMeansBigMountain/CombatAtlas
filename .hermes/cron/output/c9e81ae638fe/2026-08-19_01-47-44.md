...
- **Blocker:** Gmail source discovery failed for `all-personal`:
```text
RefreshError: invalid_grant: Token has been expired or revoked.
```
- **Remaining Daily Stoic source count:** unavailable because Gmail could not be enumerated.
- **Backlog:** A durable auth-preflight record was written:
  `/opt/data/HeRmEz/projects/faceless-youtube-channel/BACKLOG_DAILY_STOIC/all-personal-auth-preflight-20260819T014643Z.json`
  - `message_id` is `null` because authentication failed before message IDs could be discovered.
  - Source emails remain untrashed.
- **Cleanup:** No media was generated, so there was nothing to delete. Backlog records and upload ledgers were preserved. `/opt/data` has approximately 31 GB free.
- **Metrics monitor:** completed, but live statistics were unavailable because the Classical Echos metrics token also has `invalid_grant`.

### Required Workspace reauthorization

**personal-secondary — `fareed320@gmail.com`**

<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.send+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.modify+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.settings.basic+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcalendar+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcontacts+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fspreadsheets+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdocuments&state=VPlKbrklnrwGY2ojrM6DTgDN3BCRWE&code_challenge=xIS44BvxrKrWxEQSPiqA1W7PcTwIkGuLo-X-NC5avW0&code_challenge_method=S256&access_type=offline&prompt=consent+select_account&include_granted_scopes=true&login_hint=fareed320%40gmail.com>
...
<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.send+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.modify+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fgmail.settings.basic+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcalendar+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdrive+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcontacts+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fspreadsheets+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fdocuments&state=2ek9EEogxxAS6zUtlcsBR4uzepHce2&code_challenge=VrMY-3bf0PCovL3RXkznPeWkmTprwtXuXWzHFre32P4&code_challenge_method=S256&access_type=offline&prompt=consent+select_account&include_granted_scopes=true&login_hint=affan.fareed%40gmail.com>

Return:
```text
workspace:personal-main: <full localhost callback URL>
```

The A F YouTube upload token is independently revoked as well, so upload will remain blocked after Gmail recovery until `fareed320` YouTube OAuth is reauthorized.
