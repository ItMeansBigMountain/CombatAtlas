...
## Daily Stoic cron — `blocked_auth`

- **Processed:** 0
- **Uploaded:** 0
- **Public YouTube URLs:** None
- **Destination:** A F (`UCX_nUA3Yr9VR884DNanyMYA`)
- **Remaining Daily Stoic source count:** Unknown—Gmail authentication failed before message discovery.
- **Source emails:** Left untrashed.
- **Cleanup:** No new media was generated, so nothing was deleted. Backlog records and upload ledgers were preserved. Disk has **32 GB free**.
- **Metrics monitor:** Completed, but fetched 0 live statistics due to expired OAuth credentials.

Durable blocker record:

`BACKLOG_DAILY_STOIC/all-personal-auth-preflight-20260821T014625Z.json`
