...
```
{
  "workspace": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260703-014531-peertube-is-a-free-decentralized-and-federated-video-platform",
  "video": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260703-014531-peertube-is-a-free-decentralized-and-federated-video-platform/final.mp4",
  "uploaded": false
}
```
...
- Status: `ok_uploaded`
- Topic: Gemini Flash upgrade, Meta AI cloud, ZCode
- Hook: “YOU MISSED THIS”
- URL: https://youtu.be/LWekNHEboCQ
- Video ID: `LWekNHEboCQ`
- Upload: public, verified by uploader JSON
- Source email: trashed only after verified `video_id`
- Workspace: `/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260703-014957-gemini-flash-upgrade-meta-ai-cloud-zcode`
- Final MP4: uploaded, then safely deleted by uploader cleanup
- Manifest preserved: `visual_manifest.json`
- ffprobe verified before upload:
  - `1080x1920`
  - audio present
  - duration `95.568s`
- py_compile: passed
- Metrics monitor: `ok`
  ...
  - videos seen: 178
  - stats fetched: 135
- Note: first newsletter render hit an old duration quality gate. I patched the pipeline to follow the current public-upload rule, then reran and uploaded successfully.
