# Cron Job: Daily Stoic email → A F faceless video backlog processor

**Job ID:** c9e81ae638fe
**Run Time:** 2026-08-15 19:20:09
**Schedule:** 45 1 * * *
...
```
{
  "profile": "personal-secondary",
  "message_id": "1a004fbb2733ce2f",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 6 query='journaling repeated practice morning'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"journaling repeated practice morning\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"journaling repeated practice morning\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 6 query='journaling repeated practice morning'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"journaling repeated practice morning\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"journaling repeated practice morning\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"journaling repeated practice morning\", \"error\": \"no_downloadable_result\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:09.262928+00:00",
    "profile": "personal-secondary",
    "message_id": "1a004fbb2733ce2f",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19ff519302f9ea78",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 3 query='Roman emperor statue dark cinematic'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Roman emperor statue dark cinematic\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"p",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 3 query='Roman emperor statue dark cinematic'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Roman emperor statue dark cinematic\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"p\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:39.022323+00:00",
    "profile": "personal-secondary",
    "message_id": "19ff519302f9ea78",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f5112e52d7d441",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 2 query='ancient philosophy book candle hands'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"ancient philosophy book candle hands\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 429: Too Ma",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 2 query='ancient philosophy book candle hands'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"ancient philosophy book candle hands\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 429: Too Ma\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:48.825170+00:00",
    "profile": "personal-secondary",
    "message_id": "19f5112e52d7d441",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f4b462abe04514",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:51.186395+00:00",
    "profile": "personal-secondary",
    "message_id": "19f4b462abe04514",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f46206ece16ee5",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:53.626097+00:00",
    "profile": "personal-secondary",
    "message_id": "19f46206ece16ee5",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f40f9fb78b4e56",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:56.003786+00:00",
    "profile": "personal-secondary",
    "message_id": "19f40f9fb78b4e56",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f389b4024e71a7",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err\n",
  "backlog": {
    "timestamp": "2026-08-15T19:17:58.432442+00:00",
    "profile": "personal-secondary",
    "message_id": "19f389b4024e71a7",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f36ad155648eed",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 3 query='Roman emperor statue dark cinematic'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Roman emperor statue dark cinematic\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"p",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 3 query='Roman emperor statue dark cinematic'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Roman emperor statue dark cinematic\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Roman emperor statue dark cinematic\", \"error\": \"no_downloadable_result\"}, {\"p\n",
  "backlog": {
    "timestamp": "2026-08-15T19:18:26.588092+00:00",
    "profile": "personal-secondary",
    "message_id": "19f36ad155648eed",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f2dab8878c8c96",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 2 query='ancient philosophy book candle hands'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"ancient philosophy book candle hands\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 2 query='ancient philosophy book candle hands'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"ancient philosophy book candle hands\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"ancient philosophy book candle hands\", \"error\": \"no_downloadable_result\n",
  "backlog": {
    "timestamp": "2026-08-15T19:18:38.057208+00:00",
    "profile": "personal-secondary",
    "message_id": "19f2dab8878c8c96",
    "status": "backlogged",
    "email_retained": true,
...
{
  "profile": "personal-secondary",
  "message_id": "19f2ceabf8a62644",
  "error": "RuntimeError",
  "detail": "visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err",
  "traceback": "Traceback (most recent call last):\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 873, in main\n    results.append(process(profile,mid,not args.no_upload))\n                   ~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 768, in process\n    video=render(work,script)\n  File \"/opt/data/HeRmEz/projects/faceless-youtube-channel/scripts/newsletter_batch_upload.py\", line 705, in render\n    raise RuntimeError(f\"visual gate blocked: no stock/API visual asset for scene {i} query={query!r}; attempts={json.dumps(meta)[:800]}\")\nRuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'; attempts={\"provider\": \"fallback_dynamic\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"attempts\": [{\"provider\": \"pexels_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"pexels_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"HTTP Error 403: Forbidden\"}, {\"provider\": \"pixabay_photo\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"shutterstock_preview_video\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"error\": \"no_downloadable_result\"}, {\"provider\": \"wikimedia_image\", \"query\": \"Marcus Aurelius statue dramatic close up\", \"err\n",
  "backlog": {
    "timestamp": "2026-08-15T19:18:40.255517+00:00",
    "profile": "personal-secondary",
    "message_id": "19f2ceabf8a62644",
    "status": "backlogged",
    "email_retained": true,
...
Process DAILY STOIC EMAILS ONLY into faceless YouTube videos. Run /opt/data/scripts/run_faceless_video.sh from /opt/data/HeRmEz/projects/faceless-youtube-channel. One untrashed, not-yet-uploaded Daily Stoic Gmail message becomes one public video on A F (fareed320). Never process TLDR, Kino, or other newsletters in this lane. After a verified YouTube video_id, trash that source email and delete all generated media immediately. On any render/upload/auth/quota failure, leave the source email untrashed, write a durable BACKLOG_DAILY_STOIC record identifying profile+message_id and the blocker, and continue other messages; the email is the canonical remake source if the media cleanup cron later deletes partial media. Preserve backlog records and upload ledgers. Report uploaded URLs, backlog message IDs/blockers, remaining source count, and cleanup result. Load the attached skills and honor A F channel identity UCX_nUA3Yr9VR884DNanyMYA.

## Response

## Daily Stoic cron result: `blocked_provider`

- **Processed:** 10 Daily Stoic Gmail messages
- **Uploaded to A F:** 0
- **YouTube URLs/IDs:** None
- **Remaining eligible Daily Stoic sources:** 23
  - `personal-secondary`: 23
  - `personal-main`: 0

### Blocker

The stock-visual pipeline failed across all 10 attempts:

- Pexels video/photo: `HTTP 403 Forbidden`
- Pixabay video/photo: no downloadable results
- Shutterstock previews: no downloadable results
- Wikimedia: no result or `HTTP 429`
- No acceptable semantic fallback asset was available

Representative raw failure:

```text
RuntimeError: visual gate blocked: no stock/API visual asset for scene 1 query='Marcus Aurelius statue dramatic close up'
```
...
All source emails remain untrashed. Durable records were verified in:

```text
/opt/data/HeRmEz/projects/faceless-youtube-channel/UPLOADS/daily_stoic_backlog.jsonl
```

### Cleanup

No post-upload deletion ran because no upload was verified. Partial render directories remain available for diagnosis/remake:

```text
/opt/data/HeRmEz/projects/faceless-youtube-channel/videos
```

Current generated-media usage is approximately **177 MB**; filesystem has **27 GB free**. Backlog records and upload ledgers were preserved.
