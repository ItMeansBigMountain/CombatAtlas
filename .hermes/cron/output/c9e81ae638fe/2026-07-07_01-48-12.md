...
```
{
  "workspace": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260707-014501-resetting-xbox",
  "video": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260707-014501-resetting-xbox/final.mp4",
  "uploaded": false
}
```
...
Daily Faceless YouTube growth loop: ok_uploaded

- Topic/hook: Seedance 2.5, Fable guide, OpenAI GPT-5.6
- Public URL: https://youtu.be/cWiqp9ZRejk
- Video ID: cWiqp9ZRejk
- Upload status: public uploaded
- Workspace preserved: `/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260707-014549-seedance-2-5-guide-to-fable-openai-preps-gpt-5-6`
- Final MP4 cleanup: deleted after verified YouTube upload
- Source email: trashed only after verified `video_id`
- ffprobe: 1080x1920, audio present, 71.58s
- py_compile: passed
- Metrics monitor: ok, OAuth metrics working, 178 stats fetched
- TTS/visual preflight: ready
  - ElevenLabs: live but free credits exhausted
  - Google TTS: live fallback
  - Visual provider: Pixabay active
- Blocker: none
