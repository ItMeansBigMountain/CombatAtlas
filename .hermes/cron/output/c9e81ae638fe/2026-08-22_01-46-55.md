...
## Daily Stoic YouTube Cron — `blocked_auth`

- **Processed:** 0 Daily Stoic emails
- **Uploaded:** 0
- **Upload URLs:** None
- **Destination:** A F (`UCX_nUA3Yr9VR884DNanyMYA`)
- **Remaining source count:** Unknown — Gmail authentication failed before enumeration.
- **Email cleanup:** No source emails were trashed.
...
Metrics monitor ran successfully, but fetched no live statistics because the Classical Echos metrics token is also revoked.
