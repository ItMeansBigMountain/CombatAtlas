...
```
{
  "workspace": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260629-014511-glm-5-2-beats-claude-in-our-benchmarks",
  "video": "/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260629-014511-glm-5-2-beats-claude-in-our-benchmarks/final.mp4",
  "uploaded": false
}
```
...
- Status: `ok_uploaded`
- Topic: Bitcoin recovering, post-quantum private ETH, Fed crypto payment accounts
- Hook/on-screen open: `YOU MISSED THIS`
- Upload: https://youtu.be/l9te9cptUuw
- Video ID: `l9te9cptUuw`
- Privacy: `public`
- Workspace preserved: `/opt/data/HeRmEz/projects/faceless-youtube-channel/videos/20260629-014556-bitcoin-recovering-post-quantum-private-eth-fed-crypto-payment-accounts`
- Final MP4 cleanup: uploaded file was deleted after confirmed YouTube upload
- Source email: trashed only after verified `video_id`
- Metrics monitor: `ok`, OAuth metrics active, 112 stats fetched
- Verification:
  - `py_compile`: passed
  - `ffprobe`: 1080x1920, audio present, duration `128.33s`
  - Upload JSON/log: confirmed `UPLOADED`
- Assets:
  - Voice: Google TTS
  - Visuals: 8 Pixabay video assets with `visual_manifest.json` preserved
- Blocker: none
