...
**Decision**
- **No new trade.** Hold/manage existing equities and preserve **$31.70 cash**.
- Portfolio is already **83.1% deployed**, within the 70%–90% policy target.
- No options activity, order review, or order placement occurred.

**Agentic Portfolio**
- Total value: **$187.88**
- Equities: **$156.18**
- Cash/buying power: **$31.70**
- **NVDA:** 0.121165 shares at **$207.88**; average $206.33; unrealized **+$0.19 (+0.75%)**
- **SOFI:** 4.477580 shares at **$17.59**; average $17.87; unrealized **-$1.25 (-1.57%)**
- **AVGO:** 0.137376 shares at **$380.42**; average $400.36; unrealized **-$2.74 (-4.98%)**
- Options positions: **none**
- Open equity orders: **none**, verified across `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`.
- Latest order: NVDA $25 market buy filled July 14 at $206.33.

**Market Read**
- **Neutral/mixed:** large caps remain structurally constructive, but Nasdaq and semiconductors are under pressure while small caps show relative strength.
- SPY **$751.76 (-0.40%)**: above SMA10/20/50.
- QQQ **$708.33 (-1.31%)**: below SMA10/20/50; tech risk-off.
- IWM **$296.67 (+0.30%)**: near SMA10/20 and above SMA50.

**Top Candidates**
- **UNH — $451.01, +7.76%:** Earnings-driven breakout to a new 52-week high. Strongest setup, but extended; wait for a **$434–$442 retest**. Failed gap below ~$434 disconfirms.
- **NET — $270.77, -0.83%:** Above SMA10/20/50 with cloud-security and AI-agent catalysts. Watch **$260–$265 support** or a confirmed breakout above **$291**. Rich valuation increases risk.
- **XPEV — $14.36, +4.21%:** Above SMA10/20 but below SMA50. Needs a hold above $14.25 and reclaim of **$14.80**; invalidate below $13.70.
- **PYPL — $55.94:** Takeover-driven gap near its 20-day high. Binary deal risk makes it unsuitable to chase in the sandbox.
- **TSM/WDC:** Rejected today due to broken short-term structures and semiconductor weakness.

**Best Setup**
- Best paper setup: **UNH post-earnings retest**, long equity only.
- Trigger: $434–$442 holds and price reclaims intraday resistance after volatility contracts.
- Stop/invalidation: below approximately **$428**, or a full failed-gap close below $434.
- Targets: **$461**, then **$475**.
- Duration: several days to two weeks.
- Not active now; no order preview because the move is extended and the account is already appropriately deployed.

**Risk / Invalidation**
- **NVDA:** Hold; review on decisive loss of **$201–$202**. Resistance $210–$214.
- **SOFI:** Watch $17.50 closely; broader invalidation at **$16.70–$17.00**. Reclaiming $17.95–$18.30 would improve the setup.
- **AVGO:** Weakest holding. Stabilization at $378–$380 is needed; loss of **$370**, especially $356, requires exit review.
- Do not average down automatically or widen risk levels.
- QQQ and SMH weakness argues against adding semiconductor exposure.

**Tool Upgrades**
- Repair profile-scoped Google OAuth: routed TLDR/Robinhood Snacks checks were unavailable because tested tokens returned expired/revoked `invalid_grant`.
- Promote the working direct-MCP collector into a maintained scanner with P/L, spreads, volume ratios, earnings results, and open-order checks.
- Add persistent per-position trade-plan levels for faster management decisions.
- Incorporate Robinhood technical-indicator, earnings-result, and saved-scanner tools into future runs.

**Journal**
- Updated and verified:  
  `/opt/data/HeRmEz/projects/trading-journal/2026-07-16/post-morning-market-scan.md`
