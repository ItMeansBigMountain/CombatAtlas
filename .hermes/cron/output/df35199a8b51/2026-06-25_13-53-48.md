...
Decision
- No trade placed.
- Reason: broker/account state is clear and the autonomous policy is active, but the cleanest movers are extended gap leaders after the open. This is a wait-for-retest tape, not a chase tape.
- Watch item: NVDA is close to the policy review zone. If it fails to reclaim ~$199–200 or breaks lower later today, run an exit review rather than averaging down.

Agentic Portfolio
- Account: Robinhood Agentic ending 1041.
- Account value: ~$192.26.
- Buying power / cash: $126.53.
- Equity value: ~$65.73.
- Options: $0; no open option positions.
- Open-ish equity orders checked across new / queued / confirmed / unconfirmed / partially_filled: none found.
- Current positions:
  - NVDA: 0.190150 shares, avg $210.36, live ~$194.33, unrealized about -$3.05 / -7.6%.
  - SOFI: 1.685828 shares, avg $17.80, live ~$17.04, unrealized about -$1.28 / -4.3%.
- Deployment: about 34% in equities. Policy target is 70%–90% only when clean setups exist; today’s candidates do not justify forcing extra deployment.

Market Read
- SPY: ~$732.23, about -0.14% vs prior close.
- QQQ: ~$711.72, about +0.15%.
- IWM: ~$298.65, about +0.66%.
- One-line regime: neutral-to-selectively bullish; small caps are leading, while mega-cap/chip tape is mixed.

Top Candidates
- TECH / Bio-Techne:
  - Live ~$70.17, +19.2%.
  - Strong Daily Movers momentum and healthcare/life-science catalyst context.
  - Chart is very extended above the prior $58.88 close and recent $56–60 range.
  - Better plan: wait for $60–61 breakout-area retest; invalidation below ~$58.9.
  - Setup quality: strong momentum, poor immediate entry.
- MU / Micron:
  - Live ~$1170.83, +11.7%.
  - Reuters catalyst: topped estimates and guided above Street on AI memory demand / customer deals.
  - Strong liquidity and fundamental narrative, but gap is large after a volatile run.
  - Watch support/retest zones: ~$1125–1135, then ~$1080, then $1048.5 prior close.
  - Setup quality: best catalyst, but not a clean chase.
- SNDK / SanDisk:
  - Live ~$2182.82, +14.0%.
  - AI/NAND memory momentum remains strong.
  - Very high-beta and stretched; support/retest zones ~$2020, ~$1960, ~$1914.
  - Setup quality: strong trend, too volatile/extended for sandbox entry here.
- MEI:
  - Live ~$16.48, +25.9%.
  - Breakout mover, but catalyst quality was less clear and liquidity is weaker than MU/SNDK/TECH.
  - Watch support ~$14.6 then ~$14.0.
  - Setup quality: tactical only; not enough confirmation for autonomous buy.
- NUVB:
  - Live ~$5.75, -11.0%.
  - Failed recent ramp; biotech volatility with unclear catalyst in this scan.
  - Avoid.

Best Setup
- Best watchlist candidate: MU post-earnings retest.
- No immediate order.
- Balanced setup idea:
  - Trigger: MU pulls back toward ~$1125–1135 and holds with intraday stabilization while QQQ does not roll over.
  - Stop/invalidation: below ~$1080 or failed retest/VWAP structure.
  - Target: ~$1200–1211 retest.
  - Approx R:R at $1130 entry / $1080 stop / $1210 target: ~1.6:1.
  - Sandbox sizing if triggered later: small fractional starter around $30–$50 because the stop distance is wide.

Risk / Invalidation
- Do not add to NVDA or SOFI while both are red unless a fresh reclaim/support plan appears.
- NVDA management threshold: currently about -7.6% from avg; if it loses the ~$194–196 area or cannot reclaim ~$199–200, prioritize exit review.
- SOFI needs to reclaim ~$17.31–17.80 with volume before considering an add.
- For gap leaders, disconfirming signal is failure to hold the prior close / breakout retest after the morning gap.

Tool Upgrades
- Build a local scanner that combines Robinhood Daily Movers + quotes + daily bars and computes % move, 5/10/20-day SMA, ATR, relative volume, gap size, and retest distance.
- Add profile-scoped Gmail probes for specific market/newsletter labels and senders; today’s broad search mostly found TLDR InfoSec, not direct market catalysts.
- Add a “gap leader discipline” checklist: catalyst quality, gap size, retest level, distance from prior close, minimum R:R, and no-chase flag.
- Make an open-order helper that queries all open-ish Robinhood states in one reusable call sequence.

Journal
- Updated: `/opt/data/HeRmEz/projects/trading-journal/2026-06-25/post-morning-market-scan.md`
- No order preview or placement was executed.
