...
**Decision**
- No new trade.
- Autonomous policy is active and broker/account state was clear, but the sandbox is already ~83.6% deployed, inside the 70%–90% target range.
- Best action: hold/manage existing SOFI, NVDA, AVGO rather than force another entry with only $31.70 buying power.
...
- Positions:
  - SOFI: 4.47758 sh @ $17.87 avg; quote $18.595; approx +4.1% / +$3.25.
  - NVDA: 0.121165 sh @ $206.33 avg; quote $205.03; approx -0.6% / -$0.16.
  - AVGO: 0.137376 sh @ $400.36 avg; quote $390.10; approx -2.6% / -$1.41.
- Recent agentic activity: NVDA $25 buy filled this morning at $206.33; AVGO buy filled 7/9; AMD sell filled 7/8.

**Market Read**
- SPY $751.24, +0.28%; QQQ $719.27, +1.06%; IWM $295.17, +0.58%.
- Read: bullish / tech-led bounce, but not clean risk-on enough to chase after yesterday’s chip/AI weakness and current CPI/earnings/oil headline risk.

**Top Candidates**
- SOFI: best current hold. Strongest owned position, +2.56% today, holding above $18.05–$18.10 support. Watch $19.20 then $19.70–$19.75 resistance.
- NVDA: already opened as starter this morning. Current $205.03 versus $206.33 avg. Needs to reclaim/hold $206–$208; support/invalidation around $203 then $200.
- AVGO: bounce candidate but still below cost and below $400 pivot. Hold only; do not add unless it reclaims $400 with volume. Invalidation zone $383–$384, then $372.
- AMD: +4.47% intraday and strongest chip mover, but extended near highs; no chase.
- HOOD: decent fintech/crypto-beta watch, but below recent $117–$120 breakout attempt; wait for reclaim or retest near $108–$109.
- CRCL: -4.27%, weak crypto-beta tape; no trade.

**Best Setup**
- Best setup is not a new order: hold SOFI.
- Current: $18.595.
- Existing avg: $17.87.
- Stop / invalidation: daily close below $18.05 or sharp break of $17.70.
- Target 1: $19.20.
- Target 2: $19.70–$19.75.
- Thesis: liquid profitable existing position, holding support while broad market and small caps are green.
- No add because SOFI is already the largest sandbox position and portfolio deployment is already on target.

**Risk / Invalidation**
- Kill switch not triggered: account value is well above $10.
- No options considered or traded.
- No new order reviewed or placed.
- Stop trading consideration if broker state becomes uncertain, if SOFI loses $18.05/$17.70, if NVDA loses $203/$200, or if AVGO loses $383–$384.

**Tool Upgrades**
- Gmail newsletter scan was blocked: `personal-main` OAuth token is expired/revoked with `invalid_grant`; reauth needed before TLDR / Robinhood Snacks can be used reliably again.
- Robinhood saved scanners are empty; useful future upgrade would be durable scans for high relative volume, AI/semiconductor pullbacks, fintech/crypto-beta movers.
- Add a compact local scanner script for SMA10/SMA20/ATR14/20-day high/low from Robinhood historicals without large payload dumps.
- Add a position-risk helper that converts current quote + avg cost + invalidation into dollar risk automatically.

**Journal**
- Updated local journal:
  - `/opt/data/HeRmEz/projects/trading-journal/2026-07-14/post-morning-market-scan.md`
