...
**Decision**
- No new trade placed.
- Autonomous policy is active, but the cleanest decision is **hold current positions**: account is already ~73.5% deployed, inside the 70%–90% target, and both holdings are green into a strong risk-on open.
- No options considered/traded.

**Agentic Portfolio**
- Account: Robinhood Agentic ending 1041.
- Account value: **$202.58**
- Equity value: **$148.84**
- Cash / buying power: **$53.74**
- Deployment: **~73.5%**
- Positions:
  - **SOFI**: 4.477580 sh, avg $17.87, live ~$18.91, position value ~$84.69, P/L **+5.8%**, today **+3.7%**
  - **AMD**: 0.115059 sh, avg $521.47, live ~$558.00, position value ~$64.20, P/L **+7.0%**, today **+7.8%**
- Options positions: none.
- Open equity orders checked across new / queued / confirmed / unconfirmed / partially_filled: **none**
- Recent 7-day equity orders: none returned.

**Market Read**
- SPY: ~$749.10, **+0.6%**
- QQQ: ~$723.37, **+1.5%**
- IWM: ~$299.93, **+0.8%**
- One-line read: **bullish / constructive risk-on open, led by QQQ and semis, but several leaders are extended enough that gap-fade risk matters.**

**Top Candidates**
- **WULF**: ~$24.73, **+16.7%** today. Liquid Daily Movers name and fractional-tradable, but very volatile after a sharp selloff into 7/2. Good watchlist candidate, not a chase here.
- **AMD**: ~$558.00, **+7.8%** today. Existing position; AI-chip rotation beneficiary. Strong rebound, but nearing short-term resistance after a volatile June range.
- **SOFI**: ~$18.91, **+3.7%** today. Existing fintech holding; reclaiming July high zone. Cleaner small-account instrument than $500+ semis.
- **AVGO**: ~$379.72, **+5.3%** today. Semiconductor rebound from late-June weakness, but still below early-June downtrend area.
- **PLTR**: ~$132.80, **+2.7%** today. AI/software rebound from late-June low; back near prior breakdown zone, needs confirmation.

**Best Setup**
- Best action: **hold SOFI + AMD; no fresh entry.**
- SOFI management:
  - Hold while above roughly **$18.20–$18.25**
  - First decision / target zone: **$19.15–$19.25**
- AMD management:
  - Hold while above roughly **$540 intraday**
  - Hard thesis-fail zone around **$506**
  - Consider trim only if it rejects near **$580–$585** or QQQ reverses sharply.
- WULF trigger only if it retests and holds roughly **$23.50–$24.00** with continued volume. Avoid chasing the +16% open.

**Risk / Invalidation**
- Kill switch not triggered: account value is above $10 and broker/account state was certain.
- No order preview or placement because no new setup clearly beat current exposure.
- Broader invalidation: if QQQ/SPY give back the opening gap and fall below prior close, prioritize protecting current SOFI/AMD gains over adding exposure.

**Tool Upgrades**
- Build a compact Robinhood historicals scanner that outputs SMA10/SMA20/ATR14/relative-volume summaries automatically.
- Add a Daily Movers quality filter to drop OTC/ADR/fractional-closing-only names before scoring.
- Gmail personal-main is usable for Gmail read, but Calendar/Drive scopes are still insufficient; refresh scopes later if future scans need broader Workspace context.

**Journal**
- Updated local journal:
  - `/opt/data/HeRmEz/projects/trading-journal/2026-07-06/post-morning-market-scan.md`
