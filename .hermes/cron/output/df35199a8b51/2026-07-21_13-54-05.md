...
**Bought UNH in Agentic account ending 1041.** The fractional market order was reviewed, placed under the active autonomous policy, and verified filled.

## Current State

- **Portfolio value:** $184.92
- **Equity value:** $181.59
- **Cash/buying power:** $3.33
- **Open-ish orders:** None after execution
- **Kill switch:** Clear; account remains above $10
- **Positions:**
  - NVDA: 0.121165 shares @ $206.33
  - SOFI: 4.477580 shares @ $17.87
  - JPM: 0.195159 shares @ $341.67
  - UNH: 0.031089 shares @ $429.09

No options, shorts, crypto, other-account activity, or pending deposits.

## Market Regime

A tactical rebound is underway, but the correction is not fully repaired:

- SPY $744.86, +0.37%; near its 20/50-day averages
- QQQ $705.37, +1.34%; still below its 10/20/50-day averages
- IWM $293.28, +0.33%; below its 10/20-day averages
- XLK +2.08% and SMH +3.55% led
- XLF -0.21% and XLV -0.19% lagged

This supports selective, tightly invalidated starters—not chasing volatile gap leaders.

## Ranked Swing Candidates

1. **UNH — 8.0/10:** Strong Q2 EPS beat and raised 2026 earnings guidance; price held its post-earnings retest zone above the 10/20/50-day averages.
2. **JPM — 7.5/10:** Record quarterly profit, strong investment-banking growth, and bullish trend. Already held, so no add.
3. **NVDA — 7.0/10:** Reclaimed short averages during the semiconductor rebound, but remains below its 50-day average. Already held.
4. **COIN — 6.5/10:** +10.08% and testing a 20-day high, but too extended and crypto-sensitive. Wait for a $168–$171 retest.
5. **AMD — 6.0/10:** +6.11% rebound, but 7.35% ATR and elevated valuation make chasing unattractive. Prefer a $520–$525 retest.

MU and HOOD were rejected as too extended and volatile.

## Exact Action and Fill

- **Symbol:** UNH
- **Action:** Buy
- **Order:** $13.34 fractional market order
- **Filled:** 0.031089 shares
- **Average fill:** $429.085
- **Fees:** $0
- **Fill time:** 2026-07-21 13:52:49 UTC
- **Order ID:** `6a5f79b1-cccf-47bb-beff-bbb9d25cf727`

Required review disclosure:

> Bid $428.89 × 80 P · Ask $429.28 × 40 N · Last $429.26 × 200 D. Updated 9:52 AM ET.

## UNH Trade Plan

- **Setup:** Post-earnings gap/retest continuation
- **Stop/invalidation:** Sustained trade or close below $423
- **Target 1:** $450
- **Target 2:** $461.62
- **Expected duration:** Several days to two weeks
- **Planned maximum loss:** Approximately $0.19
- **Potential profit:** Approximately $0.65 at T1; $1.01 at T2
- **Risk/reward:** 3.44:1 to T1; 5.35:1 to T2

Fundamentally, UnitedHealth reported Q2 adjusted EPS of $6.38, beat expectations decisively, and raised 2026 adjusted EPS guidance to $19.50–$20.00. Technically, price remained above its 10/20/50-day averages and held the $425–$430 retest area. XLV’s relative weakness kept sizing deliberately small.

## Cash Deployment

- Pre-trade liquid buying power: **$16.67**
- Deployed: **$13.34**, or **80.02%**
- Retained liquid buffer: **$3.33**, or **19.98%**

Overall account equity deployment is approximately 98.2% because existing positions count separately from the policy’s current-liquid-balance calculation.

## Management Levels

- **NVDA:** Hold; no add. Sustained loss of approximately $198 requires exit review. Targets $214/$220.
- **SOFI:** Hold but remains weakest. Do not average down. Reclaim $17.87–$17.90 needed; sustained loss of $16.47 requires exit review.
- **JPM:** Hold; no add. Invalidation approximately $332–$333; targets $351.24/$360.
- **UNH:** Hold above $423; targets $450/$461.62. Do not widen invalidation.

## Sources and Blockers

Robinhood MCP successfully returned live account state, all practical open-order states, quotes, historicals, fundamentals, tradability, review, placement, and verified fill.

Gmail read access worked. A $1,000 transfer was detected to a **different Robinhood individual account**; that account was not accessed or traded. Calendar and Drive scopes remain unavailable but did not block this scan.

Journal saved to:

`projects/trading-journal/2026-07-21/post-open-agentic-scan.md`
