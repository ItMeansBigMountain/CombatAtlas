...
# Decision
- No new trade placed.
- Autonomous policy is present and active, and the Agentic account state was reachable, but today’s post-morning setup quality is not clean enough to force deployment.
- Market read is bearish/defensive: QQQ is leading lower, semis are weak, and the best movers are either extended, low-liquidity, or headline-risky.

# Agentic Portfolio
- Account: Agentic ending 1041
- Account value: $191.64
- Cash / buying power: $103.74
- Equity value: $87.90
- Deployment: ~45.9%
- Options: none
- Open equity orders: none found after checking new, queued, confirmed, unconfirmed, and partially_filled states.
- Positions:
  - SOFI: 1.685828 sh @ $17.80 avg; live ~$17.20; value ~$28.99; unrealized P/L about -$1.02; day -0.61%.
  - AMD: 0.115059 sh @ $521.47 avg; live ~$513.38; value ~$59.07; unrealized P/L about -$0.93; day -3.60%.
- Management note:
  - SOFI is still near its $16.80-$17.10 support zone.
  - AMD is the higher-risk hold today because QQQ/semis are weak; review exit if AMD loses the ~$507-$503 support area.

# Market Read
- SPY: $729.10, -0.71%
- QQQ: $705.57, -1.51%
- IWM: $297.37, -0.52%
- Read: bearish/defensive — tech is leading lower, small caps are holding up better but not enough to justify forcing new exposure.

# Top Candidates
- ACAD: $26.12, +10.12%
  - Best watch candidate, but not a chase.
  - Technicals: multi-day push from ~$21 to $26, volume above recent norm, strong breakout character.
  - Support / invalidation: first support ~$24.10-$23.70; hard invalidation below ~$23.20.
  - Catalyst: search surfaced Q1 2026 revenue/guidance strength, but no fresh high-confidence headline was confirmed during this run.
  - Decision: wait for pullback/retest.

- BHVN: $16.25, +5.92%
  - Technicals: strong month-long run from ~$10 to $16 with acceptable volume.
  - Support / invalidation: support ~$15.30-$15.70; invalidation below ~$14.75.
  - Catalyst: biotech/event-risk name; needs stronger catalyst confirmation before adding sandbox capital.
  - Decision: watch only.

- APOG: $47.80, +12.52%
  - Technicals: breakout/gap from the $42-$43 range.
  - Problem: liquidity/spread quality is not ideal for the small account; bid/ask was wide.
  - Decision: reject for now despite strong move.

- ON: $96.22, -18.97%
  - Technicals: breakdown, not a reversal setup yet.
  - Catalyst: web source attributes plunge to ON Semi’s ~$7B Synaptics acquisition plus broader tech/semiconductor weakness.
  - Decision: avoid catching falling knife.

- AVAV: $140.58, +2.85%
  - Technicals: bounce from steep decline/near lows, but still damaged trend.
  - Catalyst/narrative: defense/drone theme remains interesting, but chart needs reclaim/retest over ~$142-$148.
  - Decision: watch, no entry.

# Best Setup
- Best setup is ACAD pullback/retest long, but only if it cools off.
- Trigger: ACAD holds/reclaims ~$24.10-$24.50 after the gap, or consolidates and breaks higher with volume.
- Stop: below ~$23.20.
- Targets: ~$27.50 then ~$29.00.
- Risk math example: $24.50 entry / $23.20 stop = $1.30 risk per share; ~$2 sandbox risk allows about 1.54 shares, or ~$38 notional.
- At current ~$26.12, stop distance is too wide for a clean fresh entry. No order preview or placement.

# Risk / Invalidation
- Kill switch not triggered: account value is above $10.
- Broker/account state was clear enough for research and management.
- No trade because risk/reward is not clean in the current tape.
- Deployment target is 70%-90% when clean setups exist, but current deployment staying ~46% is acceptable because the policy says not to force trades.
- Existing AMD invalidation watch: break below ~$507-$503 or continued QQQ/semiconductor deterioration.
- Existing SOFI invalidation watch: clean break below ~$16.70.

# Tool Upgrades
- Gmail/newsletter source scan failed: `personal-main` OAuth returned `invalid_grant` / token expired or revoked, so TLDR and Robinhood Snacks checks were unavailable.
- Add a local scanner that auto-computes moving averages, ATR, relative volume, and support/resistance from Robinhood historicals.
- Add sector ETF checks: XLK, SMH, XLF, XBI, ITA.
- Add a wrapper that queries all open-ish equity order states in one call and summarizes them.

# Journal
- Updated: `/opt/data/HeRmEz/projects/trading-journal/2026-06-26/post-morning-market-scan.md`
