...
# Decision
- No new trade placed.
- Active autonomous policy is present and broker/account state was clear, but the account is already ~72% deployed and the cleanest candidates are extended/event-risky after the open.
- Best action: hold HOOD + NVDA, keep the $60 cash buffer, and wait for a retest instead of chasing morning gap leaders.
...
- Recent filled orders:
  - HOOD: $50 market buy filled today at avg $109.1742, agentic
  - NVDA: $40 market buy filled 2026-06-15 at avg $210.36, agentic
- Current positions:
  - HOOD: 0.993769 shares, avg $100.63, live ~$111.62; approx unrealized gain ~$10.92
  - NVDA: 0.190150 shares, avg $210.36, live ~$212.65; approx unrealized gain ~$0.44

# Market Read
- SPY: ~$749.47, +0.37% vs prior close
- QQQ: ~$743.49, +0.50% vs adjusted prior close
- IWM: ~$299.04, +1.17% vs prior close
- One-line read: neutral-bullish/constructive open, with small caps leading and tech participating, but still choppy enough to avoid chasing extended gaps.

# Top Candidates
- HOOD
  - Live ~$111.62, +3.2%.
  - Above 10d/20d MAs; pushing around recent 20d high zone.
  - Catalyst/news: fintech momentum; web result mentioned director Meyer Malka buying shares.
  - Setup: good hold, not a clean fresh add unless it retests/holds ~$108–$110.

- NVDA
  - Live ~$212.65, +0.9%.
  - Above 10d MA and reclaiming around 20d area; very liquid, ATR ~3.5%.
  - Catalyst: AI infrastructure bid intact.
  - Setup: acceptable hold; add only on clean reclaim/hold over ~$213–$214 or pullback toward ~$207–$210.

- MU
  - Live ~$1179.63, +4.0%.
  - Strongly above 10d/20d MAs; extended into/above recent highs.
  - Catalyst: June 24 earnings, analyst target raises, AI/HBM memory narrative.
  - Setup: strong watch, but too binary/extended for a fresh sandbox entry here.

- ON
  - Live ~$130.15, +7.0%.
  - Above 10d/20d MAs, near recent high zone.
  - Catalyst: power semiconductor/GaN product narrative tied to AI power infrastructure.
  - Setup: promising, but needs retest around ~$127–$129 before it becomes cleaner.

- Robinhood Daily Movers: APGE, DFTX, BWIN, HQ, BTQ, GETY
  - Many are large gaps/high volatility; GETY below $5 is disqualified by default screen.
  - Mostly watch-only unless a clean retest/base forms.

# Best Setup
- Best setup is not a new order; it is management:
  - Hold HOOD while it stays above ~$108–$110.
  - Hold NVDA while it stays above ~$207–$210.
  - Watch ON and MU, but do not chase current extension.
- Reason: account already meets deployment target, existing positions are working, and new candidates are either extended or carrying binary catalyst risk.

# Risk / Invalidation
- Kill switch not triggered: account value is above $10.
- Broker/account state: clear.
- HOOD invalidation:
  - Early warning: loss of ~$108.
  - Stronger invalidation: break below ~$104–$105 failed breakout zone.
- NVDA invalidation:
  - Early warning: loss of ~$207–$210.
  - Stronger invalidation: break below ~$199–$200 recent low zone.
- No options considered or traded.

# Tool Upgrades
- Gmail/newsletter scan failed because Google Workspace auth is unavailable in this cron environment: `NOT_AUTHENTICATED: No token at /opt/data/google_token.json`.
- Build a compact scanner that merges Robinhood Daily Movers + web/news candidates + live quotes + OHLCV indicators into ranked JSON.
- Add intraday VWAP/5-minute pullback detection; daily bars are not enough for post-open retest confirmation.
- Add automatic per-position PnL + stop/target comparison from local journal plans.

# Journal
- Updated local journal:
  - `/opt/data/HeRmEz/projects/trading-journal/2026-06-22/post-morning-market-scan.md`
