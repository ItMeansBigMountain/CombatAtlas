...
Decision
- No new trade placed.
- Account is already ~84.7% deployed, inside the 70%–90% Agentic policy target.
- Best action: hold/manage existing SOFI, HOOD, NVDA; keep $30 cash buffer.
- Reason: today’s best movers are mostly extended gap/chase setups, not clean risk entries for the small sandbox.
...
- Options: none.
- Open equity orders: none found.
- Recent order: SOFI $30 market buy filled today at avg ~$17.7954.
- Positions:
  - HOOD: 0.993769 sh, avg $100.63, quote ~$98.81, est P/L -$1.81 / -1.81%.
  - NVDA: 0.190150 sh, avg $210.36, quote ~$200.82, est P/L -$1.81 / -4.54%.
  - SOFI: 1.685828 sh, avg $17.80, quote ~$17.94, est P/L +$0.23 / +0.76%.

Market Read
- SPY: ~$736.93, +0.46%.
- QQQ: ~$716.15, +0.35%.
- IWM: ~$297.21, +0.64%.
- Read: mildly bullish bounce with small caps leading, but recent June trend damage keeps risk neutral/cautious rather than aggressive.

Top Candidates
- RUN: ~$16.42, +28.18%.
  - Catalyst: Sunrun/Tesla/Renew Home energy-capacity/data-center project.
  - Technical: huge gap from $12.81 prior close; too extended to chase. Needs retest/hold near gap VWAP or ~$15 area.
  - Verdict: strong catalyst, bad fresh-entry location.

- ABSI: ~$9.69, +30.77%.
  - Catalyst: positive Phase 1 hair-loss drug data; recent $100M offering at $7.41.
  - Technical: biotech gap, high binary/event risk.
  - Verdict: avoid for this sandbox.

- WEN: ~$7.84, +25.34%.
  - Catalyst: CFO/turnaround optimism plus meme-flow chatter.
  - Technical: sharp gap after longer-term weakness; reversal risk high.
  - Verdict: avoid; meme/turnaround spike not clean enough.

- SOFI: ~$17.94, +3.73%.
  - Catalyst/narrative: fintech strength, AI/Composer narrative, retail interest; disconfirming risk is rising loan-loss concern.
  - Technical: already entered, holding above today’s entry; best current managed position.
  - Verdict: hold, don’t add yet.

- HOOD: ~$98.81, -4.30%.
  - Technical: under pressure; needs reclaim of ~$100–$103 to repair.
  - Verdict: hold only while invalidation holds; no add.

- NVDA: ~$200.82, +0.39%.
  - Technical: stabilizing but still below recent short moving-average zone around ~$206–$210.
  - Verdict: hold small; no add until reclaim.

Best Setup
- Best setup is not a new order; it is SOFI hold/management.
- SOFI plan:
  - Entry: existing avg ~$17.80.
  - Current: ~$17.94.
  - Target 1: ~$18.50.
  - Target 2: ~$19.25 if market confirms.
  - Invalidation: failed breakout / loss of ~$16.90–$17.00.
  - Confidence: moderate; better than chasing today’s gap leaders.

Risk / Invalidation
- Kill switch not triggered: account value $196.71 > $10.
- Broker/account state was clear enough for research/management.
- No options considered or traded.
- HOOD: review/consider exit if it breaks ~$96 or cannot reclaim ~$100–$103.
- NVDA: review if it loses ~$195–$196; constructive only above ~$206–$210.
- SOFI: review if it loses ~$16.90–$17.00.
- No new trade because clean setups did not justify spending the remaining $30 cash buffer.

Tool Upgrades
- Add a local scanner that auto-computes 5/10/20-day MAs, ATR, relative volume, gap size, and setup tags from Robinhood historicals.
- Add explicit open-order helper for all open-ish states, not only `state=new`.
- Improve Gmail/news collector: `personal-main` works, but `personal-secondary` token is expired/revoked.
- Add daily-movers filters to reject sub-$5, OTC/ADR uncertainty, binary biotech gaps, and meme-only spikes unless a retest forms.

Journal
- Updated: `/opt/data/HeRmEz/projects/trading-journal/2026-06-24/post-morning-market-scan.md`
