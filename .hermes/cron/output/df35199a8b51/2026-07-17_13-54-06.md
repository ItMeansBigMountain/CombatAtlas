...
## Decision
- **No new trade.** The autonomous policy is active and broker state is verified, but the market is risk-off and both holdings require management.
- No order review, placement, cancellation, options activity, or activity in another Robinhood account occurred.

## Agentic Portfolio
- Account `433711041` / ending `1041`
- Total value: **$182.84**
- Equities: **$99.49**
- Cash/buying power: **$83.35**
- Deployment: **54.41%**
- **NVDA:** 0.121165 shares at $199.56; approximately **-$0.82 (-3.28%)**
- **SOFI:** 4.477580 shares at $16.845; approximately **-$4.59 (-5.74%)**
- No options positions.
- No open equity orders across `new`, `queued`, `confirmed`, `unconfirmed`, or `partially_filled`.
- AVGO was fully sold yesterday at $376.01.

## Market Read
- **Bearish/risk-off:** SPY $743.12 (-1.01%), QQQ $689.54 (-2.32%), IWM $294.71 (-0.30%).
- QQQ is below its 10/20/50-day averages and its prior 20-day low. Technology and semiconductors remain the main source of weakness.

## Top Candidates
- **UNH — $429.85, +1.53%:** Above its 10/20/50-day averages. Strong earnings beat and healthcare relative strength, but still volatile after the gap. **7/10; wait for confirmation.**
- **ABT — $101.45, +2.65%:** Earnings beat plus defensive-sector support. Watch a $100 hold and breakout above $102.13. **6.5/10.**
- **NET — $275.51, +1.12%:** Strong uptrend, but expensive and volatile. Better near $267–$270 support or above $291. **6/10.**
- **MAN — $54.82, +6.14%:** New 52-week high, but extended with a relatively wide spread. **5.5/10; do not chase.**
- **NFLX/ISRG:** Rejected as falling-knife post-earnings moves. NFLX was approximately -11.2%; ISRG approximately -9.1%.

## Best Setup
- **UNH earnings-retest continuation — watch only**
- Trigger: hold $425–$430, then reclaim $437.50 with healthcare relative strength.
- Invalidation: confirmed loss of approximately $423.
- Targets: $450, then $461.60.
- Several-day to two-week horizon; any live entry must retain at least 1.5:1 reward/risk and about $2 maximum planned risk.

## Risk / Invalidation
- **NVDA:** Below all major recent averages and breached the prior $201–$202 review zone. Do not add. Reclaiming $201–$202 would stabilize; sustained trade below roughly $198 raises exit priority.
- **SOFI:** Intraday low of $16.47 breached the $16.70 thesis zone before rebounding. Do not average down. It needs to reclaim $17; sustained trade below $16.70 or another $16.47 break requires exit review.
- Deployment remains below target intentionally. Raising exposure during a QQQ breakdown would be forced trading.

## Tool Upgrades
- Repair `personal-main` Google OAuth; routed TLDR and Robinhood Snacks checks failed with `invalid_grant`.
- Upgrade the compact Robinhood scanner to use earnings results, technical indicators, financials, price-book spreads, and saved/daily-mover scans.
- Normalize both list- and dictionary-shaped historical responses.
- Add persistent alerts for each holding’s written breach and reclaim levels.

## Journal
- Updated: `/opt/data/HeRmEz/projects/trading-journal/2026-07-17/post-morning-market-scan.md`
