...
# Decision
- No new trade placed.
- Autonomous policy is active, broker/account state was clear, and account value is above the $10 kill switch — but current deployment is already ~72%, market tone is soft, and the best fresh movers were extended/event-driven gaps.
- Best action: hold current positions, monitor AMD/SOFI invalidation zones, wait for cleaner retests.

# Agentic Portfolio
- Account: Agentic ending 1041.
- Portfolio value: ~$195.16.
- Equity value: ~$141.42.
- Cash / buying power: $53.74.
- Deployment: ~72.46% equities / ~27.54% cash, inside the 70%–90% target range.
- Positions:
  - SOFI: 4.47758 sh, avg $17.87, quote ~$18.34, unrealized P/L about +$2.10 / +2.63%.
  - AMD: 0.115059 sh, avg $521.47, quote ~$514.08, unrealized P/L about -$0.85 / -1.42%.
- Options: none.
...
- IWM: ~$297.44, -0.49%.
- VIXY: ~$20.75, +0.48%.
- Read: cautious / neutral-to-bearish at the open; tech is the weak link, so avoid forcing new long exposure.

# Top Candidates
- CRNX: ~$83.51, +98.68%. Huge biotech gap on rare/endocrine pipeline news/data flow; volume exploded above average and price hit a 52-week high. Too extended for this sandbox without a retest/base.
- AGIO: ~$42.29, +13.11%. Rare-disease hematology catalyst; FDA priority review / mitapivat sickle-cell context. Better structure than CRNX, but still a biotech gap with headline risk and not enough clean risk math at current price.
- DOCN: ~$140.53, +6.97%. AI-native cloud / Q1 beat / AI ARR narrative supports interest, but chart is still repairing from a sharp drawdown. Needs reclaim of ~$146.50–$150 or a controlled pullback.
- RIVN: ~$17.63, -12.46%. Negative dilution catalyst from 75M-share offering / ~$1.5B raise overwhelmed earlier delivery-strength news. No long add.
- Existing SOFI: ~$18.34, -1.45%. Hold; add only if it reclaims/holds ~$18.75–$19.20 or pulls back and defends ~$17.75–$18.00.
- Existing AMD: ~$514.08, -6.88%. Hold/watch; AI-chip thesis intact but today’s tape is weak. Review exit if it loses ~$506–$509 with QQQ still weak.

# Best Setup
- Best setup is **no trade / wait**.
- Watch triggers:
  - AGIO: only consider if it holds above ~$42.60 with volume expansion and a stop under ~$39.40.
  - DOCN: only consider on reclaim of ~$146.50–$150 with market confirmation.
  - SOFI: possible add only above ~$18.75–$19.20 or on a clean pullback holding ~$17.75–$18.00.

# Risk / Invalidation
- Kill switch: not triggered.
- Broker/account state: clear.
- Risk calculation: possible, but no clean new-entry setup.
- SOFI invalidation: loss of ~$17.75–$18.00.
- AMD invalidation/review zone: loss of ~$506–$509, especially if QQQ remains weak.
- No options, no shorts, no non-Agentic accounts touched.

# Tool Upgrades
- Add compact Daily Movers scanner: filter OTC/wide-spread names, compute SMA10/SMA20/ATR14/relative volume, output small ranked JSON.
- Add exact Gmail-label probe for routed labels like `Hermes/Finance/Robinhood` and TLDR aliases instead of broad keyword search.
- Add scanner preset: price > $5, avg volume > 500k, today move 3%–15%, relative volume > 1.5x, fractional tradable, spread < 0.25%.
- Add position alert script for SOFI/AMD invalidation zones.

# Journal
- Updated local journal:
  - `/opt/data/HeRmEz/projects/trading-journal/2026-07-07/post-morning-market-scan.md`
- No order preview or placement was performed.
