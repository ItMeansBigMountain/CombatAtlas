...
## Viral Clip Radar backlog drain — `blocked_auth`

- **Uploaded public URLs:** None
- **queue_before:** 1
- **queue_after:** 1
- **hold_queue:** 1
- **pipeline_exit:** 1
- **Durable log:** `/opt/data/HeRmEz/projects/viral-clip-radar/OUTPUTS/backlog-processor-logs/2026-08-19T090020Z.log`
- **Failed clip preserved:** `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/chris-williamson-q-a-becoming-a-dad-health-update-f-02-daily.mp4`
- **Metadata preserved:** `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/chris-williamson-q-a-becoming-a-dad-health-update-f-02-daily.mp4.upload.json`

The queue was verified after execution. The rendered clip was not deleted. The reported hold count is from the backlog processor; there is no separate `HOLD_QUEUE` directory.

### Blocker

All three Viral Radar upload/failover profiles have revoked or expired OAuth grants: Classical Echos, Trapiistan/Sosai Oyama, and fareed320/A F.
