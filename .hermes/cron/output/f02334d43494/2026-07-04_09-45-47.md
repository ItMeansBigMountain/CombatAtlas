...
Processed newsletter/source emails from `personal-secondary`.

- Status: `ok_uploaded`
- Uploaded: 16 public videos
- Source cleanup: all 16 source emails trashed after verified `video_id`
- Metrics monitor: OK, OAuth metrics working
- Preflight: OK
  - ffmpeg/ffprobe ready
  - ElevenLabs auth OK, but free credits are exhausted
  - Google TTS OK and used as production fallback
  - Pixabay stock visuals ready
  - YouTube upload token worked

Uploads:

- SharePoint RCE / Cursor RCE / NetNut  
  https://youtu.be/U9xLo_4jwfQ

- AI employee costs / SaaS playbook / Notion HTML  
  https://youtu.be/Lclyf1Z3Jnk

- Ethereum Institutional / Berachain / Solana governance  
  https://youtu.be/xn2YdL9NGkQ

- AI Agent Ransomware / Cloudflare AI crawlers / Safari MCP  
  https://youtu.be/GBsAr6fFJE8

- AI labels hurt social proof / B2B AEO  
  https://youtu.be/uc_GFWFVAKQ

- Fable 5 safeguards / Safari MCP / code review  
  https://youtu.be/9mp-0NdTlA4

- Boundary 1.0 / Floci AWS Emulator / ContextForge  
  https://youtu.be/8VsMQMD-nKU

- Tesla 6-seat Model Y / Meta AI disappointment  
  https://youtu.be/gKaky-_0maE

- CUDA kernel breakdown / Meta design system / formal verification  
  https://youtu.be/qRskKV7zfHs

- Tired marketing / TikTok mini dramas / content pillars  
  https://youtu.be/LYK53EQd-jU

- iPhone 18 leaks / Codex Micro / verifiable outputs  
  https://youtu.be/HEfnR_I5oxE

- Airwallex $11B valuation / Meta prediction market / AI off switch  
  https://youtu.be/C7RSashak2Q

- AI Budget Boom / Agents Need Owners / Workday guardrails  
  https://youtu.be/34QPnCwqXZo

- Strategy mNAV Dip / Hyper Foundation grants / IBIT investors  
  https://youtu.be/TDHAPKKeur0

- Agent-led growth / building in public / dev Notion  
  https://youtu.be/Jvj7dgs2jb8

- Mythos at home / refactoring the business / 12 Factor Agents  
  https://youtu.be/BJHgIHcprvU

Notes:

- All renders passed vertical/audio checks: 1080x1920 with audio.
- A few videos ran longer than the ideal Shorts range, but they were real TTS + stock-visual renders, not placeholders.
- There are still at least 10 eligible unread source emails remaining in `personal-secondary`; I stopped after this large batch to avoid runaway cron/upload spam.
