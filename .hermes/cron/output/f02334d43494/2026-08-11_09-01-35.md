...
- **Uploaded:** `0/10`
- **Public URLs:** None
- **Rendered upload failures deleted:** None
- **Durable log:** `/opt/data/HeRmEz/projects/viral-clip-radar/OUTPUTS/backlog-processor-logs/2026-08-11T090046Z.log`
- **Protected hold item:** `UPLOAD_QUEUE_HOLD/alex-hormozi-8-entrepreneurs-compete-for-100-00-02-daily.mp4.upload.json`

### Blocker

Source acquisition failed for the selected Hamza Unfiltered video:

`https://www.youtube.com/watch?v=1HC76d9RGH4`

```text
ERROR: [youtube] 1HC76d9RGH4: Sign in to confirm you’re not a bot. Use --cookies-from-browser or --cookies for the authentication.
urllib.error.HTTPError: HTTP Error 403: Forbidden
urllib.error.HTTPError: HTTP Error 400: Bad Request
```

The pipeline seeded 10 current creator plans, but produced no clips and therefore did not meet the required minimum of 10 public uploads. This is a downloader/source-authentication bot-check, not YouTube upload OAuth failure, so no upload OAuth recovery URL applies. Recovery requires valid YouTube playback cookies, a residential proxy, a rights-safe direct/local source, or working pytubefix device OAuth.
