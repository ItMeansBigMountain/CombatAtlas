...
- **queue_before:** `0`
- **queue_after:** `0` (filesystem verified)
- **hold_queue:** `1` (filesystem verified)
- **pipeline_exit:** `1`
- **Durable raw log:** `OUTPUTS/backlog-processor-logs/2026-08-04T090046Z.log`
- **Preserved hold item:** `alex-hormozi-8-entrepreneurs-compete-for-100-00-02-daily.mp4.upload.json`

**Blocker:** No reviewed manifest clips were available. This was not an authentication failure, so no OAuth recovery URL is required.
