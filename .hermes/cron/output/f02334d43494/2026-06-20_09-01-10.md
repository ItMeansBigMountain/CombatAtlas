...
- Metrics monitor ran OK:
  ...
  - 147 video IDs seen.
  - 104 stats fetched.
- Loaded the faceless viral rules from:
  - `/opt/data/HeRmEz/projects/faceless-youtube-channel/VIRAL_YOUTUBE_SYSTEM.md`
- Tried the newsletter batch pipeline for:
  - `personal-secondary`
  - fallback/old fareed320 profile: `fareed320.old-20260612-193356`
- Exact blocker:
  - Gmail OAuth refresh failed.
  - Error: `invalid_grant: Token has been expired or revoked.`
- Token files exist and are mode `600`, but both Gmail source tokens are revoked/expired:
  - `/opt/data/google_profiles/personal-secondary/google_token.json`
  - `/opt/data/google_profiles/fareed320.old-20260612-193356/google_token.json`
- YouTube Sosai/Trapiistan token exists:
  - `/opt/data/secrets/youtube-trapiistan/youtube_upload_token.json`

Nothing was rendered, uploaded, or trashed because source Gmail access is blocked. Reauth needed for the fareed320 / personal-secondary Gmail profile before this cron can process unread approved newsletters.
