...
## Viral Radar backlog drain — **BLOCKED**
...
- **hold_queue:** `1`
- **pipeline_exit:** `2`
- **Durable log:** `/opt/data/HeRmEz/projects/viral-clip-radar/OUTPUTS/backlog-processor-logs/2026-08-10T090047Z.log`
- **Failed rendered clips deleted:** No

### Blockers

1. **YouTube OAuth is expired/revoked for both Viral Radar upload profiles.**
2. **Source acquisition failed across the attempted backlog:** yt-dlp was disabled; pytubefix returned HTTP 403/400; pytube returned HTTP 400.
3. Two source-ready candidates could not render because their expected local source MP4s were missing.
4. No rendered upload failures were added to the active queue; the missing deficit consists of never-rendered clips.
...
```text
"method": "yt-dlp",
"error": "skipped by --no-ytdlp or VIRAL_RADAR_DISABLE_YTDLP=1"
...
```text
source file missing for clip mr-belmar-nate-belma-74-and-thriving-life-lessons-with-01: /opt/data/HeRmEz/projects/viral-clip-radar/SOURCES/zHlFgDJyUu8/source.mp4
...
https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=ZPiGlezxO1xVzgt08JQaqlh1WbuMj4&code_challenge=CQKqN9xTMMRsnTGWNUrMg0knCR3uzYs393_knEPqKZ0&code_challenge_method=S256&access_type=offline&include_granted_scopes=true&prompt=consent+select_account&login_hint=trapiistan%40gmail.com
