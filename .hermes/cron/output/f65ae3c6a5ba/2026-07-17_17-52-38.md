...
# Afternoon Swing & Rotation Scan — Agentic 1041

**Decision: Hold; no new trade or rotation.** No order was reviewed, placed, replaced, or cancelled because no candidate passed the technical, risk/reward, and portfolio-fit gates.

## Live Account State

- **Account:** 433711041 / ending 1041 only
- **Portfolio value:** $186.64
- **Equity value:** $103.29
- **Cash / liquid buying power:** $83.35
- **Current deployment:** 55.34%
- **Policy allocation from liquid balance:** $66.68 deployable / $16.67 required reserve
- **Actual cash retained:** $83.35
- **Kill switches:** Clear; account is above $10 and up approximately 1.72% from the opening snapshot
- **Open orders:** None in `new`, `queued`, `confirmed`, `unconfirmed`, or `partially_filled`
- **Today’s fills:** None

Recent fills remain the July 16 AVGO sale at $376.01 and July 14 NVDA purchase at $206.33.

## Position Management

### NVDA — Hold, no add

- 0.121165 shares at $206.33
- Live: $205.22
- Unrealized: -$0.13 (-0.54%)
- Technicals: above SMA20 near $202.22; RSI 52.12; semiconductor flow remains weak
- **Exit review:** sustained break below $198 with QQQ/SMH confirmation
- **Targets:** $214, then $224

### SOFI — Hold, no add

- 4.477580 shares at $17.87
- Live: $17.505
- Unrealized: -$1.63 (-2.04%)
- Technicals: below SMA20 near $17.92; RSI 46.74; July 29 earnings create event risk
- **Review level:** sustained loss of $16.70
- **Hard thesis invalidation:** below $16.47
- **Targets:** $19.20, then $19.70–$19.75

Aggregate risk to written invalidations is approximately **$5.51**, within the policy’s default ~$6 aggregate-risk target. Stops were not widened.

## Market Regime

Broad risk-off rotation continued:
...
Energy was the only clear sector leader. Semiconductor and discretionary weakness argued against adding high-beta growth exposure.

## Ranked Opportunities

1. **XOM:** strongest sector alignment, but RSI near 74 and intraday fade made the entry extended.
2. **UNH:** earnings-supported recovery and healthy trend, but post-earnings extension lacked a controlled retest.
3. **TRV:** strong earnings beat, but an 8% event gap offered no efficient structural entry.
4. **RKLB:** relative intraday strength, but still far below its SMA20; oversold bounce rather than confirmed reversal.
5. **ASTS/STX:** strong momentum but extended in a risk-off tape.

No candidate provided a clean trigger, realistic invalidation, and at least 1.5:1 reward/risk without chasing. The nominal $66.68 deployment target was therefore not forced.

**Actions/fills:** None.  
**Final deployment:** 55.34%.  
**Cash retained:** $83.35, including the required $16.67 reserve.

Journal: `/opt/data/HeRmEz/projects/trading-journal/2026-07-17/afternoon-scan.md`
