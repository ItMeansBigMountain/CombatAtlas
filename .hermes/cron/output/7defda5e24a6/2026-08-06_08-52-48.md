...
PR [#14682](https://github.com/runelite/plugin-hub/pull/14682) remains **open and blocked pending Plugin Hub maintainer review**.

- **Submission scope:** Correct—exactly one changed file, `plugins/bis-loadouts`
- **Child commit:** `da1cf0329c7b9013f27bc1c9798a372d55958606`
- **Build check:** Passed
- **Plugin Hub check:** Reports “Requires maintainer review”
- **Mergeability:** Mergeable, but blocked by the required review
- **Feedback:** No formal reviews or inline comments; issue comments contain only automated status messages
- **Annotations:** Two unrelated upstream workflow deprecation warnings under `.github`; neither concerns BIS Loadouts
- **State:** Not merged; no code correction or manifest update requested
