...
PR [#14682](https://github.com/runelite/plugin-hub/pull/14682) remains **open, unmerged, mergeable, and blocked pending maintainer review**.

- **Submission scope:** Correct—only `plugins/bis-loadouts` is changed.
- **Manifest commit:** `da1cf0329c7b9013f27bc1c9798a372d55958606`
- **Build check:** Passed.
- **Plugin Hub check:** Reports “Requires maintainer review”; this is the only blocking condition.
- **Feedback:** No formal reviews or inline comments. The two issue comments are automated status messages and request no correction.
- **Warnings:** Two unrelated Plugin Hub infrastructure deprecation warnings; neither concerns BIS Loadouts.
- **Action taken:** None required. No child or manifest changes were made.
