...
PR #14682 remains **open and awaiting RuneLite Plugin Hub maintainer review**:

- **Submission scope:** Valid single-plugin PR; only `plugins/bis-loadouts` is changed.
- **Child commit:** `da1cf0329c7b9013f27bc1c9798a372d55958606` as expected.
- **Build check:** Passed.
- **Plugin Hub check:** Blocked with “Requires maintainer review,” not a code failure.
- **Feedback:** No maintainer issue comments, formal reviews, or inline comments requiring action.
- **Merge state:** Mergeable, but blocked pending review.
- **Local child repository:** Clean and still at the submitted commit.

No changes or responses were needed this run.

https://github.com/runelite/plugin-hub/pull/14682
