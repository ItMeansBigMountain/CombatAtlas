...
PR **#14682** remains open and correctly scoped.

- **PR:** https://github.com/runelite/plugin-hub/pull/14682
- **State:** Open, not merged, not draft
- **Files changed:** Exactly one — `plugins/bis-loadouts`
- **Child commit:** `da1cf0329c7b9013f27bc1c9798a372d55958606`
- **Build check:** Passed
- **Plugin Hub check:** Awaiting required maintainer review
- **Feedback:** No maintainer comments, formal reviews, or inline review comments
- **Last PR update:** August 3, 2026 at 17:36 UTC

No code or manifest changes are currently requested, so no action was taken.
