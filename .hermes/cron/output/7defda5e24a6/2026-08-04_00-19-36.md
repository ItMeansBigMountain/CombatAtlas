...
BIS Loadouts Plugin Hub PR status: **open, awaiting maintainer review**.

- PR: https://github.com/runelite/plugin-hub/pull/14682
- State: Open; not draft; not merged
- Submission remains correctly isolated to exactly one file: `plugins/bis-loadouts`
- Manifest points to the required child commit: `da1cf0329c7b9013f27bc1c9798a372d55958606`
...
- Issue comments: only Plugin Hub automation; no maintainer feedback
- No repository changes or replies were needed during this run.
