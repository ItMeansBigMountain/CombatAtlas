...
- Single-plugin constraint satisfied: only `plugins/bis-loadouts` is changed.
- Manifest still points to child commit `da1cf0329c7b9013f27bc1c9798a372d55958606`.
- Build check: **passed**.
- Plugin Hub check: **“Requires maintainer review”**; this is the only blocking status.
- Formal reviews: none.
- Inline review comments: none.
- Issue comments: only automated Plugin Hub messages; no correction requested.
- No code, manifest, branch, or PR changes were needed.
