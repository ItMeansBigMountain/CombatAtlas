...
- Child repository is clean and checked out at that exact commit
- Build check: **passed**
- Plugin Hub check: **blocked only because maintainer review is required**
- Issue comments contain no correction request
- Formal reviews: none
- Inline review comments: none
- No code or manifest changes were needed or made
