...
PR #14682 remains **open** and is awaiting RuneLite Plugin Hub maintainer review.
...
- **Issue comments:** Bot status messages only; no correction requested
- **Formal reviews:** None
- **Inline comments:** None
- **Check annotations:** Two unrelated Plugin Hub workflow deprecation warnings; no BIS Loadouts action required
- **PR:** https://github.com/runelite/plugin-hub/pull/14682

No code, manifest, or PR changes were needed.
