...
- **Submission scope:** Correct—only `plugins/bis-loadouts` is changed; no second plugin is present.
...
- **Feedback:** No maintainer issue comments, formal reviews, or inline review comments requesting changes.
- **Action taken:** None; the PR is awaiting maintainer review.
