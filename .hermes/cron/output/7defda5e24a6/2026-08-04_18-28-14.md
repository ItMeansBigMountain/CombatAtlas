...
- Build check: **passed**.
- Plugin Hub check: **requires maintainer review**; this is the only blocker.
- No maintainer comments, formal reviews, or inline review comments.
