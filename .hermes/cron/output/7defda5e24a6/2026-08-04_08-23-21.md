...
PR [#14682](https://github.com/runelite/plugin-hub/pull/14682) remains open and mergeable, but is blocked pending Plugin Hub maintainer review.

- **Submission scope verified:** exactly one changed file, `plugins/bis-loadouts`
- **Child commit verified:** `da1cf0329c7b9013f27bc1c9798a372d55958606`
- **Build check:** passed
- **Plugin Hub check:** “Requires maintainer review”
- **Formal reviews:** none
- **Inline review comments:** none
- **Issue comments:** only automated submission/review-status notices
- **PR state:** open, not merged, not draft

No code correction or PR update is currently requested, so no changes were made.
