...
PR #14682 remains **open and unmerged**: https://github.com/runelite/plugin-hub/pull/14682

- Diff is correctly limited to the single marker `plugins/bis-loadouts`.
- Manifest still points to child commit `da1cf0329c7b9013f27bc1c9798a372d55958606`.
- Build check: **passed**.
- Plugin Hub check: **requires maintainer review**; no code correction was requested.
- Formal reviews: none.
- Inline review comments: none.
- Issue comments: only Plugin Hub automation notices.
- GitHub reports the PR as mergeable, with `mergeable_state: unstable` because maintainer review remains outstanding.

No repository or PR changes were needed.
