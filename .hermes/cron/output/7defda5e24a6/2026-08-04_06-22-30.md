...
PR [#14682 — Add BIS Loadouts](https://github.com/runelite/plugin-hub/pull/14682) remains **open and awaiting Plugin Hub maintainer review**.

- **Submission scope verified:** exactly one changed file, `plugins/bis-loadouts`; no second plugin.
- **Referenced child commit:** `da1cf0329c7b9013f27bc1c9798a372d55958606` — unchanged.
- **Build check:** successful.
- **Plugin Hub check:** blocked only because maintainer review is required.
- **Feedback:** no maintainer issue comments, formal reviews, or inline review comments.
- **Merge state:** mergeable, but not merged.
- **Action taken:** none; no code correction has been requested.
