...
PR [#14682](https://github.com/runelite/plugin-hub/pull/14682) remains **open** and mergeable, but blocked pending Plugin Hub maintainer review.

- Submission remains correctly isolated to **one file/plugin**: `plugins/bis-loadouts`
- Manifest still points to child commit `da1cf0329c7b9013f27bc1c9798a372d55958606`
- Build check: **passed**
- Plugin Hub check: marked **failure only because maintainer review is required**
- Formal reviews: none
- Inline review comments: none
- Maintainer correction requests: none
- Build annotations are repository-level deprecation warnings unrelated to BIS Loadouts

No code or manifest changes are currently needed.
