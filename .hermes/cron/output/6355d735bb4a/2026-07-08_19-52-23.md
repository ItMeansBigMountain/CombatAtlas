...
- Metrics preflight: ok
  ...
  - Videos seen: 289
  - Stats fetched: 196
- YouTube auth healthcheck: ok
  - No token/channel/dependency problems found
- Upload account used: Classical Echos only
- Final command exit: `1`
  - Reason: `blocked_min_uploads_not_met`

Discovered creator videos:

- Chris Williamson / Alex Hormozi
  - Source: `The Emotional Pattern That Predicts Career Failure - Alex Hormozi`
  - URL: https://www.youtube.com/watch?v=emYGGGHT1mE
  - Uploaded: 3 / 10
  - IDs:
    - `oFXSM7RBmMQ` — https://youtu.be/oFXSM7RBmMQ
    - `VAsuHcnrwDI` — https://youtu.be/VAsuHcnrwDI
    - `akqfmB6Xm1E` — https://youtu.be/akqfmB6Xm1E
  - Failed to reach 10: yes

- Kinobody / Greg O’Gallagher
  - Source: `The Complete Guide to Fat Loss with GLP-1s (Tirzepatide)`
  - URL: https://www.youtube.com/watch?v=iQm0CpG6038
  - Uploaded: 0 / 10
  - Blocker: source download failed
    - `yt-dlp` skipped by config
    - `pytubefix`: HTTP 403 Forbidden
    - `pytube`: HTTP 400 Bad Request
  - Failed to reach 10: yes

- GG33
  - Source: `The only sign that can HYPNOTISE you with its EYES`
  - URL: https://www.youtube.com/shorts/813qE0pqEok
  - Uploaded: 1 / 10
  - ID:
    - `nCI0KczwtnU` — https://youtu.be/nCI0KczwtnU
  - Failed to reach 10: yes

- GG33
  - Source: `Women born in Dragon Years are ALPHA WOMEN`
  - URL: https://www.youtube.com/shorts/Yuul6zDvqbg
  - Uploaded: 1 / 10
  - ID:
    - `wUF0IC47Wd0` — https://youtu.be/wUF0IC47Wd0
  - Failed to reach 10: yes

- GG33
  - Source: `Astrologt Signs that HATE FAT PEOPLE`
  - URL: https://www.youtube.com/shorts/ul86mdS6DHg
  - Uploaded: 1 / 10
  - ID:
    - `aylNDKmrMyY` — https://youtu.be/aylNDKmrMyY
  - Failed to reach 10: yes

- Alex Hormozi
  - Source: `She Never Wanted to Change Anything About Me`
  - URL: https://www.youtube.com/shorts/wDyQOdWx0v8
  - Uploaded: 1 / 10
  - ID:
    - `finCvpsi_8k` — https://youtu.be/finCvpsi_8k
  - Failed to reach 10: yes

- Alex Hormozi
  - Source: `You Cannot Wish for Strong Character and an Easy Life`
  - URL: https://www.youtube.com/shorts/QnBXoVkygA0
  - Uploaded: 1 / 10
  - ID:
    - `scgDRltspr8` — https://youtu.be/scgDRltspr8
  - Failed to reach 10: yes

Queue:

- Remaining upload queue count: 30
- No upload-limit error hit during this run.
- Failed rendered uploads were not observed in the output.
- The 30 queued items appear to be pre-existing/recovery queue items, not used to satisfy today’s strict discovered-source minimum.

Other discovery blockers:

- TateSpeech / Andrew Tate:
  - YouTube uploads playlist lookup returned 404 `playlistNotFound`
- Luke Belmar:
...
- 8 public Shorts uploaded.
- Every discovered source failed the strict 10-upload minimum.
- Main blocker pattern:
  - Short-form sources only yielded 1 clip each.
  - Kinobody long-form source could not be downloaded from this cloud/IP/session path.
  - Chris Williamson long-form only produced/uploaded 3 clips before the strict job stopped below minimum.
