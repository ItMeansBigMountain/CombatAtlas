...
Viral Radar creator watchlist run: **blocked_upload_quota**

- Metrics monitor: `ok`
  - OAuth metrics working.
  - Viral Radar median public views: `30`.
  - Current winners: Hormozi / Huberman / GG33 style clips.

- Queue replay:
  - queued_replay_uploaded_count: `0`
  - remaining_queue_count: `8` MP4s + `8` metadata files
  - First queued upload hit YouTube account upload limit.

- Daily cap / used:
  - Configured default cap: `12/day`
  - YouTube returned hard cap error before any upload completed:
  - `uploadLimitExceeded`: “The user has exceeded the number of videos they may upload.”

- New source found:
  - `How loyal each sign is - PART 1`
  - `https://www.youtube.com/shorts/n6-Pj3RFRCc`
  - Plan created:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-07-07-gg33-how-loyal-each-sign-is-part-1-n6-Pj3RFRCc`

- Uploaded_count: `0`
- URLs/video IDs: none

- Queued latest failed clip:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/20260707133552-kinobody-greg-o-gall-the-future-of-fat-loss-is-here-tir-02-daily.mp4`
  - Title: `Why Your Fitness Plan Feels Rigged`
  - Source: Kinobody / Greg O'Gallagher
  - Source URL: `https://www.youtube.com/watch?v=2ejxPzyy75E`

- Blocker:
  - `blocked_upload_quota`
  - Script exited nonzero: `exit_code=1`
  - Exact failure: YouTube API `HttpError 400 uploadLimitExceeded`.

- Min-upload contract:
  - `blocked_min_uploads_not_met`
  - Required: `10`
  - Completed: `0`
  - Reason: Classical Echos upload limit already exceeded.
