...
Strict Viral Radar run: blocked by YouTube upload quota.

- Metrics preflight: ok
  - OAuth metrics fetched.
  - 279 videos seen.
  - 186 stats fetched.
- Auth/channel healthcheck: ok
  - No token/channel/dependency problems reported.
- Discovered creator video:
  - GG33 — “Cue App DOMINATION”
  - Source ID: `5E4atXW9FjE`
  - Source URL: https://www.youtube.com/watch?v=5E4atXW9FjE
  - Plan: `CLIP_PLANS/2026-07-08-gg33-cue-app-domination-5E4atXW9FjE`
- Render/queue result:
  - Rendered exact-source clip attempted:
    - `gg33-cue-app-domination-auto-01-captioned-daily.mp4`
  - Upload failed with YouTube:
    - `uploadLimitExceeded`
    - “The user has exceeded the number of videos they may upload.”
  - The failed rendered clip was safely queued for retry:
    - `UPLOAD_QUEUE/gg33-cue-app-domination-auto-01-captioned-daily.mp4`
    - Metadata: `UPLOAD_QUEUE/gg33-cue-app-domination-auto-01-captioned-daily.mp4.upload.json`
- Uploaded count:
  - GG33 / Cue App DOMINATION: `0`
  - URLs/video IDs: none created this run.
- Queue count:
  - `40` queued MP4s
  - `40` queue metadata JSON files
- Minimum check:
  - GG33 / Cue App DOMINATION failed to reach 10 uploads.
  - Blocker: YouTube daily/account upload limit, not source/auth/render failure.
- Final status:
  - `blocked_upload_quota`
  - No old queue, NASA/space filler, unknown creators, or unrelated fallback videos were used.
