...
- Metrics monitor: `ok`
  ...
  - Current winners still skew Alex Hormozi / GG33 / strong self-improvement clips.

Discovered creator videos this run:

- GG33 — “Why some women are better than men”
  - Source: https://www.youtube.com/shorts/JcDN01TbKxA
  - Plan: `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-07-10-gg33-why-some-women-are-better-than-men-JcDN01TbKxA`
  - Uploaded: `1 / 10`
  - Public Short: https://youtu.be/nzmzJEdAznI
  - Video ID: `nzmzJEdAznI`
  - Failed minimum: yes

- Alex Hormozi — “What Working Hard Actually Looks Like”
  - Source: https://www.youtube.com/shorts/WfBbvitjO8E
  - Plan: `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-07-10-alex-hormozi-what-working-hard-actually-looks-like-WfBbvitjO8E`
  - Uploaded: `1 / 10`
  - Public Short: https://youtu.be/CpAskrvYPNU
  - Video ID: `CpAskrvYPNU`
  - Failed minimum: yes

- Alex Hormozi — “He Has No Employees...”
  - Source: https://www.youtube.com/shorts/pyRg4SRiWoo
  - Plan: `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-07-10-alex-hormozi-he-has-no-employees-pyRg4SRiWoo`
  - Uploaded: `1 / 10`
  - Public Short: https://youtu.be/lrkae-8_njY
  - Video ID: `lrkae-8_njY`
  - Failed minimum: yes

Blockers / issues:

- Main blocker: `blocked_min_uploads_not_met`
  - Each discovered source only produced/uploaded 1 clip.
  - Required minimum was 10 per source.
  - No source/render failures were reported by the script.
- Watchlist discovery skips:
  - TateSpeech / Andrew Tate: YouTube uploads playlist lookup returned 404.
  - Luke Belmar: no recent long-form videos found.
  - Capital Club Community / Luke Belmar: uploads playlist lookup returned 404.
- Command exited non-zero: `exit_code=1`.

Queue status:

- Active upload queue: `4`
- Hold queue: `1`
- Script-reported remaining queue count: `4`

Important note:

- The job did publish 3 public Shorts, but all 3 discovered sources failed the strict `10 uploads per discovered creator video` requirement.
