...
Viral Radar strict run completed with blockers.
...
- Andrew Huberman
  - `How to Access Calm, Confident Energy in You & Your Dog`
  - Source: https://www.youtube.com/shorts/4MIXQTyy9Fo
  - Uploaded: `1 / 10`
  - Public URL: https://youtu.be/NFdWUyG5BAE
  - Video ID: `NFdWUyG5BAE`
  - Failed strict minimum.

- Chris Williamson
  - `What’s The Biggest Evolutionary Sex Difference?`
  - Source: https://www.youtube.com/shorts/qWDyse6OA8Q
  - Uploaded: `0 / 10`
...
- Chris Williamson
  ...
  - Source: https://www.youtube.com/watch?v=Kbh71hXk6MM
  - Uploaded: `0 / 10`
  - Blocker: YouTube source download failed.
    - yt-dlp skipped by strict/no-ytdlp setting.
    - pytubefix: HTTP 403 Forbidden.
    - pytube: HTTP 400 Bad Request.
    - Logs: `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/Kbh71hXk6MM`
  - Failed strict minimum.

- GG33
  - `How most NPCs Cope in Life`
  - Source: https://www.youtube.com/shorts/ZvqPrFA3YbA
  - Uploaded: `0 / 10`
  - Blocker: `no reviewed manifest clips available`
  - Failed strict minimum.

- Alex Hormozi
  - `You're Not Burned Out, You Need the Next Level`
  - Source: https://www.youtube.com/shorts/nVDSsGDO6Do
  - Uploaded: `1 / 10`
  - Public URL: https://youtu.be/d3lFB7DNrhg
  - Video ID: `d3lFB7DNrhg`
  - Failed strict minimum.

Queue:

- Remaining queue count reported by run: `0`
- No failed rendered clips were left queued.
- Rendered successful exports were deleted after confirmed upload.

Overall status:

- Command exit code: `1`
- Uploaded total: `2`
- Sources that failed to reach 10: `5 / 5`
- Main blockers:
  - Newly discovered Shorts only produced 1 reviewed clip each.
  - Some plans had no reviewed manifest clips.
  - One long-form Chris Williamson source hit YouTube cloud/IP/source download blocks.
