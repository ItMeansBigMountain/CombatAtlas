...
Strict Viral Radar run result: `blocked_min_uploads_not_met`

- Metrics monitor: `ok`
  - OAuth metrics working.
  - 185 stats fetched.
  - Viral Radar median public views: 35.
  - Current winners still Alex Hormozi / Huberman-style clips.

- Auth healthcheck: `ok`
  - No YouTube token/channel problems detected.
  - Classical Echos token passed.

Discovered creator videos:

- Chris Williamson
  - `Why Is Gen Z Spending Like The World’s Ending? - Caleb Hammer`
  - Source: https://www.youtube.com/watch?v=TbdUgswa0hE
  - Uploaded: `0/10`
  - Blocker: source download failed.
  - yt-dlp was skipped/disabled.
  - pytubefix hit `HTTP 403`.
  - pytube hit `HTTP 400`.
  - Logs: `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/TbdUgswa0hE`

- GG33
  - `5 Astrology Signs that THRIVE NEAR WATER`
  - Source: https://www.youtube.com/shorts/81D304tPJHA
  - Uploaded: `0/10`
  - Rendered clip was queued after upload failure.
  - Blocker: YouTube `uploadLimitExceeded`
  - Queued file:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/gg33-5-astrology-signs-that-thrive-near-water-auto-01-captioned-daily.mp4`

- GG33
  - `Aquariuses have an edge right now`
  - Source: https://www.youtube.com/shorts/pTTW2_iJetg
  - Uploaded: `0/10`
  - Rendered clip was queued after upload failure.
  - Blocker: YouTube `uploadLimitExceeded`
  - Queued file:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/gg33-aquariuses-have-an-edge-right-now-auto-01-captioned-daily.mp4`

- Alex Hormozi
  - `Make the Calls Whether You Love It or Hate It`
  - Source: https://www.youtube.com/shorts/wH5hs4-KCXM
  - Uploaded: `0/10`
  - Rendered clip was queued after upload failure.
  - Blocker: YouTube `uploadLimitExceeded`
  - Queued file:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/alex-hormozi-make-the-calls-whether-you-love-it-or-hate-it-auto-01-captioned-daily.mp4`

- Alex Hormozi
  - `How to Scale From $4M to $400M With Content You Already Have`
  - Source: https://www.youtube.com/shorts/MRU0JSF2sOw
  - Uploaded: `0/10`
  - Rendered clip was queued after upload failure.
  - Blocker: YouTube `uploadLimitExceeded`
  - Queued file:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/alex-hormozi-how-to-scale-from-4m-to-400m-with-content-you-alrea-auto-01-captioned-daily.mp4`

- Hamza Unfiltered
  - `I’m not stopping this extreme work season yet.`
  - Source: https://www.youtube.com/watch?v=UarGmWFzd0c
  - Uploaded: `0/10`
  - Blocker: source download failed.
  - yt-dlp was skipped/disabled.
  - pytubefix hit `HTTP 403`.
...
Skipped watchlist sources:

- TateSpeech / Andrew Tate
  - YouTube uploads playlist not found / 404.
- Luke Belmar
  - No recent long-form videos found.
- Capital Club Community / Luke Belmar
  - YouTube uploads playlist not found / 404.

Uploads:

- Public uploads completed: `0`
- URLs/video IDs: none returned.
- Queue count now: `36` MP4s + `36` metadata files.
- New rendered clips queued this run: `4`
- Every discovered source failed to reach the strict `10` minimum.

Main blockers:

- YouTube upload quota is currently exhausted for Classical Echos: `uploadLimitExceeded`.
- Long-form YouTube source acquisition is still blocked without cookies/proxy/local source/OAuth downloader path.
