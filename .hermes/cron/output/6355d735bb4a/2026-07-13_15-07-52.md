...
- Metrics monitor:
  - Status: `ok`
  - But live token metrics blocked by revoked tokens:
    - Classical Echos: `invalid_grant`
    - Trapiistan/Sosai: `invalid_grant`

- Upload queue:
  - Drained first.
  - Uploaded queued GG33 clip:
    - https://youtu.be/zxYwY4UHmIo
  - `queue_count`: 0

- Seeded latest watchlist manifests:
  - Andrew Huberman long-form found.
  - Chris Williamson long-form found.
  - Hamza long-form found.
  - Hamza Unfiltered long-form found.
  - Several watchlist channels had no recent long-form or playlist lookup blockers.

- Source: GG33 — “The Dark Truth about Earth and Your Soul”
  - Source URL: https://www.youtube.com/watch?v=qRPw-khPGz4
  - Uploaded count: 5/5
  - Public uploads:
    - https://youtu.be/zxYwY4UHmIo
...
- Source: Chris Williamson — “Why Everyone Is Drowning In Debt”
  - Source URL: https://www.youtube.com/watch?v=nulkcjbI-pI
  - Uploaded count: 0/5
  - Status: BLOCKED_SOURCE
  - Reason:
    - YouTube source acquisition failed.
    - `pytubefix`: HTTP 403.
    - `pytube`: HTTP 400.
    - A source file existed but ffprobe reported invalid/corrupt media.
  - No rendered clips were created.
  - Queue is empty because this deficit was never renderable, not because it succeeded.
  - Log path:
    - `LOGS/daily_youtube_source_download/nulkcjbI-pI`

- Hardening done:
  - Updated `scripts/upload_to_youtube.py` so Viral Radar can fail over on revoked/expired OAuth tokens, not just upload-limit errors.
  - This allowed public uploads through the verified `fareed320` token.

- Durable report:
  - `STATE/strict_discovered_run_2026-07-13_report.json`

- Next action:
  - Reauth Classical Echos and Trapiistan YouTube tokens.
  - Retry Chris Williamson source with cookies, residential proxy, or local MP4.
  - Keep status PARTIAL until every selected source reaches 5/5.
