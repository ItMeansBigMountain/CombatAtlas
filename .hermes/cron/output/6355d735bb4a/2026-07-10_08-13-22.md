...
Viral Radar strict run: `blocked_min_uploads_not_met`

- Metrics preflight: `ok`
  - 404 logged videos seen.
  - 311 stats fetched.
  - Current Viral Radar winners still skew Alex Hormozi / GG33 / high-conflict self-improvement clips.
- Auth preflight: `ok`
  - No YouTube auth/channel/dependency problems reported.

Discovered creator videos this run:

- Kinobody / Greg O’Gallagher — “Kinobody at peak”
  - Source: https://www.youtube.com/shorts/XPWKaYBvwRQ
  - Uploaded: 1 / 10
  - Public URL: https://youtu.be/RliaWVkvDUI
  - Video ID: `RliaWVkvDUI`
  - Failed minimum: yes

- Mr Belmar / Nate Belmar — “My Top 5 Tips To Get Shredded”
  - Source: https://www.youtube.com/shorts/t6i0ggvK29c
  - Uploaded: 1 / 10
  - Public URL: https://youtu.be/44YYas3NUEI
  - Video ID: `44YYas3NUEI`
  - Failed minimum: yes

- Mr Belmar / Nate Belmar — “Methylene Blue Eye Drops”
  - Source: https://www.youtube.com/shorts/Kq0_3HJjijA
  - Uploaded: 1 / 10
  - Public URL: https://youtu.be/DOlXaZ-g8fI
  - Video ID: `DOlXaZ-g8fI`
  - Failed minimum: yes

- Alex Hormozi — “The Ultimate Motivation”
  - Source: https://www.youtube.com/shorts/jxZgpKchnT8
  - Uploaded: 1 / 10
  - Public URL: https://youtu.be/AH94wJg6E70
  - Video ID: `AH94wJg6E70`
  - Failed minimum: yes

- Alex Hormozi — “Will Mim Scale or Fail? Scale or Fail EP 2”
  - Source: https://www.youtube.com/shorts/Zk8Gs6uoKLM
  - Uploaded: 1 / 10
  - Public URL: https://youtu.be/yHXQJ9119Hs
  - Video ID: `yHXQJ9119Hs`
  - Failed minimum: yes

Blockers:

- Main blocker: each newly discovered source was a YouTube Short, so the pipeline only rendered/uploaded 1 real clip per source.
- Strict minimum was 10 per discovered source, so all 5 sources failed the required minimum.
- No upload auth blocker.
- No render failure reported.
- No source acquisition failure reported for these 5 uploaded clips.
- Watchlist discovery also skipped:
  - TateSpeech / Andrew Tate: YouTube playlist lookup 404.
  - Luke Belmar: no recent long-form found.
  - Capital Club / Luke Belmar: YouTube playlist lookup 404.

Queue:

- Upload queue currently has 8 files.
- That appears to be 4 queued clip+metadata pairs.
- The uploaded clips from this run were deleted after confirmed upload, per log.

Net:

- 5 public Shorts uploaded to Classical Echos.
- 0 discovered sources reached the strict 10-upload minimum.
- Job exited nonzero because strict minimum was not met.
