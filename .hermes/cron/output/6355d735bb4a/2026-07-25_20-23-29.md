...
Strict watchlist run completed. Existing `UPLOAD_QUEUE` was checked first and the latest long-form manifests were seeded with five distinct clip windows each.

### Per-source results

- **Andrew Huberman — 5/5 public**
  - https://youtu.be/jLF3xt6SYW0
  - https://youtu.be/SuUtngZchoE
  - https://youtu.be/Lw5bx_8qoIg
  - https://youtu.be/0XmH7HNK5ok
  - https://youtu.be/myiyfx1R46A

- **Chris Williamson — 0/5**
  - Source: https://www.youtube.com/watch?v=V5A9q4HZ1Ro
  - Blocked during source acquisition.

- **Kinobody / Greg O’Gallagher — 1/5**
  - https://youtu.be/2F0bvsQwrjk
  - Four clips remain unrendered because no reviewed manifest clips remained after the first upload.

- **Cobratate / Andrew Tate — 5/5 public**
...
- **GG33 — 0/5**
  - Source: https://www.youtube.com/watch?v=_LMTdi9oyhc
  - Blocked during source acquisition.

- **Mr Belmar / Nate Belmar — 0/5**
  - Source: https://www.youtube.com/watch?v=daR7_ts9G2Y
  - Blocked during source acquisition.
...
- **Alex Hormozi — 4/5**
  ...
  - One clip remains unrendered/unplanned.

- **Hamza — 0/5**
  - Source: https://www.youtube.com/watch?v=T1VS2zpAy2U
  - Blocked during source acquisition.

- **Hamza Unfiltered — 0/5**
  - Source: https://www.youtube.com/watch?v=bkUbo-to768
  - Blocked during source acquisition.

- **Ryan Holiday / Daily Stoic — 0/5**
  - Source: https://www.youtube.com/watch?v=OaodPkr48qg
  - Blocked during source acquisition.

### Queue

- **queue_count: 0**
- This does **not** mean the deficits are complete. No rendered upload failures remain; the missing clips were never rendered because source acquisition or manifest availability failed.

### Primary blocker

The source downloader exhausted the configured non-provider ladder:

```text
pytubefix: HTTP Error 403: Forbidden
pytube: HTTP Error 400: Bad Request
yt-dlp: skipped because VIRAL_RADAR_DISABLE_YTDLP=1
```

YouTube upload authentication and channel checks passed. Metrics monitor also succeeded: 372 video IDs seen and 346 statistics records fetched.

### Next action

Provide a fresh authenticated YouTube cookie/session, a residential proxy, or local/direct MP4s for the blocked source URLs. Then regenerate reviewed five-clip manifests for Kinobody and the remaining Alex Hormozi clip and replay the strict source-specific runs. No NASA, unknown-creator, stock, or old-queue filler was used.
