...
**Uploaded URLs:** None  
**Queue count:** 1 rendered clip preserved  
**Metrics:** 383 videos found; 0 live statistics fetched because Classical Echos OAuth returned `invalid_grant`.

### Newly discovered sources

- **Andrew Huberman — Jocko Willink: Resilience, Identity & Leadership**  
  https://www.youtube.com/watch?v=lxDf8uEypJU  
  **Uploaded: 0/5** — five-window manifest and clips were never generated because authenticated duration/transcript seeding is blocked.

- **Chris Williamson — Why Almost Nobody Gets the Life They Want**  
  https://www.youtube.com/watch?v=D60hHjROMts  
  **Uploaded: 0/5** — five-window manifest and clips were never generated because authenticated duration/transcript seeding is blocked.

- **Daily Stoic — Do We Really Control Our Reactions?**  
  https://www.youtube.com/shorts/b6FdyK8TQ0M  
  **Uploaded: 0/5** — this source is itself a YouTube Short and cannot support five distinct transformative clips. A longer Daily Stoic source is required.

### Existing upload queue

The previously rendered Kinobody clip remains safely queued and does **not** count toward the newly discovered-source minimum:

`UPLOAD_QUEUE/kinobody-greg-o-gallagher-a-follower-called-me-out-for-using-tir-auto-01-captioned-daily.mp4`

Its latest upload attempt failed with:
...
Reauthorize at least one upload profile, drain the exact queued Kinobody render, seed five clips each for the new Huberman and Williamson videos, process both to **5/5**, and replace the too-short Daily Stoic source with a longer source-ready video.

Durable report: `OUTPUTS/strict-viral-radar-run-2026-07-30T153340Z.json`
