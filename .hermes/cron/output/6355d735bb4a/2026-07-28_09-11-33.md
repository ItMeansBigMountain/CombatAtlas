...
- **Uploaded URLs:** None
- **New watchlist sources seeded:** 0
- **UPLOAD_QUEUE:** 1 rendered clip
- **Metrics monitor:** 383 video IDs found; 0 statistics fetched because Classical Echos OAuth returned `invalid_grant`
- **Run artifact:** `OUTPUTS/strict-viral-radar-run-2026-07-28T091045Z.json`
...
- **Uploaded:** **0/5**
- **Rendered and safely queued:** 1
- **Never rendered/planned deficit:** 4
- This is existing exact-source backlog and was not counted as a newly discovered source.

### Blockers

```text
google.auth.exceptions.RefreshError: ('invalid_grant: Token has been expired or revoked.', {'error': 'invalid_grant', 'error_description': 'Token has been expired or revoked.'})
queue item last_attempt_at=2026-07-28T09:00:50.110504+00:00
metrics: video_ids_seen=383 stats_fetched=0
```

Both **Classical Echos** and **Trapiistan/Sosai** tokens are expired or revoked. Queue draining failed, and latest-watchlist discovery could not access the YouTube Data API. No expensive downloading or rendering was started after the failed preflight.

### Required reauthorization

**Classical Echos:**  
https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=xbBU8r1nF0BrXsbhniFwOqY3LcTBiw&code_challenge=3CXHGjURuoAIBpH8s_I9xw_N-ECPGENv3Onj5CL-G0U&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=classicalechos%40gmail.com

**Trapiistan/Sosai:**  
https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=wTwBq6d9ZF466TXxtyDyaw0tpG6l2A&code_challenge=TToAoCRJZpOprXPv41aq70WRwLVZ8uBJw7-j-eExmNk&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=trapiistan%40gmail.com

Return both complete redirected localhost URLs as:
...
**Next action:** Exchange and verify both callbacks, drain the exact queued clip first, then seed fresh long-form watchlist manifests and run the strict five-public-clips-per-source pipeline.
