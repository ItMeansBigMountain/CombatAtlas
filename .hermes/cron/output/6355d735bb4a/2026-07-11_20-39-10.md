...
- Metrics monitor:
  ...
  - Videos seen: 444
  - Stats fetched: 351
  - Current Viral Radar winners still skew Alex Hormozi / strong truth-blame hooks.

- Discovered creator videos this run:
  - Chris Williamson — “Why The AI Doomers Might Be Right - Robert Wright”
    - Source: https://www.youtube.com/watch?v=TNCZJTduDpQ
    - Uploaded: 0/10
  ...
  - GG33 — “Ox people have a secret power”
    - Source: https://www.youtube.com/shorts/LVSOUX72NVc
    - Uploaded: 0/10
    - Status: failed
    - Blocker: no reviewed manifest clips available.

  - GG33 — “Being born on the 4th in America is a CHEAT CODE”
    - Source: https://www.youtube.com/shorts/6ttrLFS_FK4
    - Uploaded: 0/10
    - Status: failed
    - Blocker: no reviewed manifest clips available.

  - GG33 — “How every sign will do you 2026”
    - Source: https://www.youtube.com/shorts/A7NX_8o0Drw
    - Uploaded: 0/10
    - Status: failed
    - Blocker: no reviewed manifest clips available.

  - Alex Hormozi — “You Get the Trait From the Shit”
    - Source: https://www.youtube.com/shorts/sWJPMqs3g-o
    - Uploaded: 1/10
    - Public Short:
      - https://youtu.be/f6tID4wbUh0
      - Video ID: f6tID4wbUh0
    - Status: failed minimum
    - Queue count: 0

  - Alex Hormozi — “If It Scales, It’s Free. If It Doesn’t, You Pay.”
    - Source: https://www.youtube.com/shorts/tKLdrlLIn1g
    - Uploaded: 1/10
    - Public Short:
      - https://youtu.be/XWUsoBhbaXY
      - Video ID: XWUsoBhbaXY
    - Status: failed minimum
    - Queue count: 0

  - Hamza Unfiltered — “How To Tell If A Girl Is A Hoe (From Hamza’s paid course)”
    - Source: https://www.youtube.com/watch?v=wtdpEsuSF0U
    - Uploaded: 0/10
    - Status: failed minimum
    - Blocker: source download failed.
    - Attempts:
...
- Upload account:
  - Uploaded Shorts used Classical Echos lane as required.

- Sources that failed to reach 10:
  - All 7 discovered sources failed to reach the 10-Short minimum.

- Overall status:
  - `blocked_min_uploads_not_met`
  - 2 public Shorts uploaded.
  - 0 queued replay clips reported.
  - Main blockers are YouTube source acquisition for long-form videos and missing reviewed manifests for several newly discovered Shorts.
