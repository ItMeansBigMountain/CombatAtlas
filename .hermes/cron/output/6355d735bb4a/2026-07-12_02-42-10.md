...
Strict Viral Radar run finished: `blocked_source / failed_manifest_review`
...
- Uploads: `0`
- Queue count: `0`
- Sources that failed to reach 10 uploads: `4/4`
- Durable report saved:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/STATE/strict_discovered_run_2026-07-12_report.json`

Discovered videos:

- Chris Williamson — “The Uncommon Path Is Lonely”
  - Source: https://www.youtube.com/shorts/IrtjpGlBoE0
  - Plan: `CLIP_PLANS/2026-07-12-chris-williamson-the-uncommon-path-is-lonely-IrtjpGlBoE0`
  - Uploaded: `0`
  - Blocker: `no reviewed manifest clips available`
  - Extra verification: source file missing, manifest only has `1` planned clip, below strict min `10`

- Chris Williamson — “Are Extroverts Happier Than Introverts?”
  - Source: https://www.youtube.com/shorts/Iv5Cq2KImsU
  - Plan: `CLIP_PLANS/2026-07-11-chris-williamson-are-extroverts-happier-than-introverts-Iv5Cq2KImsU`
  - Uploaded: `0`
  - Blocker: `no reviewed manifest clips available`
  - Extra verification: source file missing, manifest only has `1` planned clip, below strict min `10`

- GG33 — “The exception of Enemy Signs”
  - Source: https://www.youtube.com/shorts/Ltx0D1_qZgE
  - Plan: `CLIP_PLANS/2026-07-11-gg33-the-exception-of-enemy-signs-Ltx0D1_qZgE`
  - Uploaded: `0`
  - Blocker: `no reviewed manifest clips available`
  - Extra verification: source file missing, manifest only has `1` planned clip, below strict min `10`

- Alex Hormozi — “I Think You Can Do More”
  - Source: https://www.youtube.com/shorts/9zM3CcyDU8Q
  - Plan: `CLIP_PLANS/2026-07-12-alex-hormozi-i-think-you-can-do-more-9zM3CcyDU8Q`
  - Uploaded: `0`
  - Blocker: `no reviewed manifest clips available`
  - Extra verification: source file missing, manifest only has `1` planned clip, below strict min `10`

No old queue items, placeholders, NASA/space filler, or unrelated fallback videos were used.
