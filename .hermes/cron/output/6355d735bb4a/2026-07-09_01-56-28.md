...
- Main job exit: `1`
- Product status: `blocked_min_uploads_not_met`

Discovered creator videos:

- Chris Williamson — “Ego”
  - Source: https://www.youtube.com/shorts/POj2j5tt9OU
  - Uploaded: 1 / 10 minimum
  - URL: https://youtu.be/Sd-SxcWTVhU
  - Video ID: `Sd-SxcWTVhU`
  - Failed minimum: yes

- Chris Williamson — “Should AI Be Regulated For Kids?”
  - Source: https://www.youtube.com/shorts/DBf_J_ZUGwE
  - Uploaded: 1 / 10 minimum
  - URL: https://youtu.be/8eESIJSCGes
  - Video ID: `8eESIJSCGes`
  - Failed minimum: yes

- Kinobody / Greg O’Gallagher — “What Have I Changed Since Using Tirzepatide”
  - Source: https://www.youtube.com/shorts/O_bbHlvVpBs
  - Uploaded: 0 / 10 minimum
  - Failed minimum: yes
  - Blocker: render failed in ffmpeg.
  - Error: invalid crop/scale path produced no output packets.

- GG33 — “The Chameleons of Numerology & Astrology”
  - Source: https://www.youtube.com/shorts/dehxhUHlbpI
  - Uploaded: 1 / 10 minimum
  - URL: https://youtu.be/4pmMh7HLLQ8
  - Video ID: `4pmMh7HLLQ8`
  - Failed minimum: yes

- Alex Hormozi — “Will Nas Scale or Fail?”
  - Source: https://www.youtube.com/shorts/PekDF8M6iic
  - Uploaded: 1 / 10 minimum
  - URL: https://youtu.be/Db-BsNoykH0
  - Video ID: `Db-BsNoykH0`
  - Failed minimum: yes

Queue / retry state:

- Remaining queue count reported by job: `30`
- Uploaded clips were deleted after confirmed upload.
- Rendered failed Kinobody clip did not upload because render failed before usable output.

Watchlist/source blockers:
...
- The strict procedure did discover 5 creator videos.
- It did not reach the required 10 public Shorts for any discovered source.
- Only 4 public Shorts were uploaded total.
- No old queue, NASA/space, unknown, evergreen, or stock filler was used.
