...
- **Metrics monitor:** OK — 308 uploads observed, 282 statistics fetched. Current top-performing pattern remains specific Alex Hormozi power/business hooks.
- **Queue drain:** Attempted first.
- **Watchlist seeding:** 10 latest long-form creator manifests seeded.
- **Public uploads this run:** 2
- **UPLOAD_QUEUE:** 0

### Per-source results

**Kinobody / Greg O’Gallagher — “The Exact Tirzepatide Dose I Use (And If I’ll Ever Stop)”**  
Source: https://www.youtube.com/watch?v=i38tRKN0A7U  
Result: **1/5 public clips — PARTIAL**

- https://youtu.be/b7XsBVsFLB8

Four additional clips were not successfully rendered/uploaded. They are an **unrendered backlog deficit**, not queued upload failures.

**Kinobody / Greg O’Gallagher — “Why ‘Just Eat More Protein’ Doesn’t Work to Get Lean”**  
Source: https://www.youtube.com/watch?v=hIWOrZHI7wc  
Result: **1/5 public clips — PARTIAL**

- https://youtu.be/hjZ6WFIqqFQ

Four additional clips were not successfully rendered/uploaded. They are an **unrendered backlog deficit**, not queued upload failures.

### Blockers

- Numerous remaining creator plans failed source acquisition.
- Typical raw application failure:
...
- Some pytubefix attempts also failed while interpreting YouTube’s current player JavaScript.
- `queue_count=0` does **not** mean the minimums were completed. No rendered upload failures remain queued; the deficits were never rendered because source acquisition or planning did not produce enough usable clips.
- Watchlist metadata also failed for TateSpeech and Capital Club Community due missing/invalid uploads playlists. Luke Belmar and TOGI returned no recent qualifying long-form videos.
- No NASA, space, unknown-creator, stock, or placeholder clips were used.

### Next action

Restore source acquisition with fresh authenticated YouTube cookies, the approved Classical Echos pytubefix OAuth session, a residential proxy, or local/direct source MP4s. Then rerun the exact deficient source manifests until each reaches at least **5/5 public uploads**.

Durable raw log:

`/opt/data/HeRmEz/projects/viral-clip-radar/OUTPUTS/backlog-processor-logs/2026-07-21T103752Z.log`
