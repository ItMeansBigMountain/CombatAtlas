...
- Discovered creator videos:
  - Chris Williamson — “The 20 Hour Rule People Waste Time Avoiding”
    - Source: https://www.youtube.com/shorts/cNzHgXo2cgc
    - Uploaded: 1 / 10
    - URL: https://youtu.be/IEQuKcuTIF0
    - Failed minimum: yes

  - Kinobody / Greg O’Gallagher — “Kinobody x Fonzian”
    - Source: https://www.youtube.com/shorts/IMFmV0OIjdw
    - Uploaded: 0 / 10
    - Rendered clip upload hit YouTube upload limit.
    - Queued exact rendered clip for retry:
      - `UPLOAD_QUEUE/kinobody-greg-o-gallagher-kinobody-x-fonzian-auto-01-captioned-daily.mp4`
    - Failed minimum: yes

  - Kinobody / Greg O’Gallagher — “Lifting”
    - Source: https://www.youtube.com/shorts/1CkhFmeZing
    - Uploaded: 1 / 10
    - URL: https://youtu.be/SpjPewduXxQ
    - Failed minimum: yes

  - GG33 — “gg33 stream w hassan”
    - Source: https://www.youtube.com/watch?v=9rortpe8yYo
    - Uploaded: 1 / 10
    - URL: https://youtu.be/XySbmY_vZQc
    - Next rendered clip hit YouTube upload limit.
    - Queued exact rendered clip for retry:
      - `UPLOAD_QUEUE/gg33-gg33-stream-w-hassan-02-daily.mp4`
    - Failed minimum: yes

  - Alex Hormozi — “Fix Your Business in 90 Days, Win $100,000 - Episode 2”
    - Source: https://www.youtube.com/watch?v=j2TZMFkj71Q
    - Uploaded: 0 / 10
    - Blocker: source unavailable right now.
    - YouTube says it premieres in ~11 hours / treated as live-stream unavailable by pytubefix/pytube.
    - Failed minimum: yes

  - Alex Hormozi — “How We Got 500,000 Leads for a Book Launch”
    - Source: https://www.youtube.com/shorts/s8RSjblOel4
    - Uploaded: 0 / 10
    - Rendered clip upload hit YouTube upload limit.
    - Queued exact rendered clip for retry:
      - `UPLOAD_QUEUE/alex-hormozi-how-we-got-500-000-leads-for-a-book-launch-auto-01-captioned-daily.mp4`
    - Failed minimum: yes

- Upload blocker:
  - Classical Echos hit YouTube daily upload/quota limit:
    - `rateLimitExceeded`
    - `uploadLimitExceeded`
  - No failover used because this strict run required Classical Echos only.

- Queue count now:
  - 4 queued MP4s
  - 4 queued metadata files

- Existing queue item still present:
  - `chris-williamson-everything-you-learned-in-school-is-a-lie-topup-auto-10-captioned-daily.mp4`

- Final status:
  - `blocked_upload_quota`
  - Command exited non-zero.
  - All 6 discovered sources failed to reach the strict minimum of 10 public Shorts.
