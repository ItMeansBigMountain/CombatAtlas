...
# Viral Radar — **BLOCKED_AUTH**

- **Uploaded URLs:** None
- **Per-source uploaded count:** N/A / 5 — authenticated discovery failed before a source could be selected
- **Active `UPLOAD_QUEUE`:** 0 rendered clips
- **`queue_count=0`**
- **Held queue:** 1 old metadata record; its referenced MP4 is missing, so it is not uploadable and does not count
- **Metrics:** 436 video IDs found; 0 live statistics fetched because Classical Echos OAuth failed
- **Report:** `OUTPUTS/strict-discovered-report-20260810T231929Z.md`

This is **not success**. The remaining deficit was never planned or rendered because watchlist seeding failed during OAuth refresh.

## Blockers

All Viral Radar upload profiles return:
...
The latest-watchlist seeder was attempted with five clips per source and an eight-minute minimum source duration, but OAuth failed before source selection.

## Required next action

Open each fresh authorization URL while signed into the specified account. Return the **full localhost callback URL** using the corresponding prefix.

### Classical Echos — `classicalechos@gmail.com`

Prefix: `youtube:classicalechos:`

<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=8VkiPeYgahzD6M8mECFJ4fVC5kWhbo&code_challenge=5Kb6clYYyPUGoU5G0EtvVJgakbMRHm8MTW-twfvlJ38&code_challenge_method=S256&access_type=offline&include_granted_scopes=true&prompt=consent+select_account&login_hint=classicalechos%40gmail.com>

### Trapiistan/Sosai — `trapiistan@gmail.com`

Prefix: `youtube:trapiistan:`

<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=hsIfMBdl5tq42QCLtSqgV2z71ktN3c&code_challenge=hoZmR3MNbhLixLGQ_mlTbVOk-dRHmdA7LiXEWu2dG2k&code_challenge_method=S256&access_type=offline&include_granted_scopes=true&prompt=consent+select_account&login_hint=trapiistan%40gmail.com>

### fareed320 — `fareed320@gmail.com`

Prefix: `youtube:fareed320:`

<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=U9foD849bOAY4bpNC2YAnN5gqQ5k8Q&code_challenge=XFFDRDTLNNMAva5Rkfh4bQPux5WTrV1G2jRtnfQV21k&code_challenge_method=S256&access_type=offline&include_granted_scopes=true&prompt=consent+select_account&login_hint=fareed320%40gmail.com>

After reauthorization, the next run must seed fresh long-form sources and render/upload **5/5 distinct public clips from each exact selected source**, queueing every rendered upload failure.
