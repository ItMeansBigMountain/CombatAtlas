...
Strict Viral Radar run finished with blockers.

- Metrics monitor: `ok`
  - OAuth metrics worked.
  - 442 video IDs seen.
  - 349 stats fetched.
- Auth healthcheck: `blocked_auth_hardening`
  - No token/profile failure shown.
  - Code guard missing: Classical Echos failover guard snippet.
  - This run was Classical-only as requested.

Discovered creator videos:

- Chris Williamson — “Superior Grip”
  - Source: https://www.youtube.com/shorts/7kdo07ngR5Q
  - Plan: `CLIP_PLANS/2026-07-11-chris-williamson-superior-grip-7kdo07ngR5Q`
  - Uploaded: `1 / 10`
  - URL: https://youtu.be/AVkctd3W2C8
  - Video ID: `AVkctd3W2C8`
  - Status: failed minimum, only 1 uploaded.

- GG33 — “Everything abour the Dog Sign”
  - Source: https://www.youtube.com/shorts/yzi3JC7AdO0
  - Plan: `CLIP_PLANS/2026-07-10-gg33-everything-abour-the-dog-sign-yzi3JC7AdO0`
  - Uploaded: `0 / 10`
  - Blocker: `no reviewed manifest clips available; add/review a new clip manifest`
  - Status: failed minimum.

- GG33 — “Most Likely Lifepath to have Family Issues”
  - Source: https://www.youtube.com/shorts/Pht5N6vwNBs
  - Plan: `CLIP_PLANS/2026-07-10-gg33-most-likely-lifepath-to-have-family-issues-Pht5N6vwNBs`
  - Uploaded: `0 / 10`
  - Blocker: `no reviewed manifest clips available; add/review a new clip manifest`
  - Status: failed minimum.

- Alex Hormozi — “What I Would Do To Go From 0 To 1M In 2026”
  - Source: https://www.youtube.com/shorts/iB1qgf2My4s
  - Plan: `CLIP_PLANS/2026-07-11-alex-hormozi-what-i-would-do-to-go-from-0-to-1m-in-2026-iB1qgf2My4s`
  - Uploaded: `0 / 10`
  - Blocker: `no reviewed manifest clips available; add/review a new clip manifest`
  - Status: failed minimum.

- Alex Hormozi — “Discounting Is Negotiating With Terrorists”
  - Source: https://www.youtube.com/shorts/XDpoaCYMhKU
  - Plan: `CLIP_PLANS/2026-07-10-alex-hormozi-discounting-is-negotiating-with-terrorists-XDpoaCYMhKU`
  - Uploaded: `1 / 10`
  - URL: https://youtu.be/dohVeYtqqMQ
  - Video ID: `dohVeYtqqMQ`
  - Status: failed minimum, only 1 uploaded.

Other watchlist blockers/skips:

- TateSpeech / Andrew Tate
  - Blocker: YouTube playlist lookup 404 / playlist not found.
- Luke Belmar
  - Blocker: no recent long-form videos found.
...
- Upload queue count: `0`
- No failed rendered clips were left queued by this run.

Overall status:

- `blocked_min_uploads_not_met`
- Total uploaded this run: `2`
- Every discovered source failed to reach the required `10` uploads.
- No NASA/space/unknown/old queue filler was used.
