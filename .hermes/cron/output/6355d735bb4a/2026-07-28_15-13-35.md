...
- **Uploaded URLs:** None
- **New watchlist manifests:** 0
- **Queue count:** 1 rendered clip with metadata, safely preserved
- **Metrics monitor:** 383 video IDs seen; 0 statistics fetched because OAuth refresh failed
- **Run artifact:** `OUTPUTS/strict-viral-radar-run-2026-07-28T151252Z.json`
...
- **Kinobody / Greg O’Gallagher — “A Follower Called Me Out For Using Tirzepatide”**
  ...
  - **Uploaded: 0/5**
  - 1 rendered clip remains in `UPLOAD_QUEUE`
  - 4 additional clips were never rendered or planned; this deficit is not represented by the queue count
  - This is existing exact-source backlog and was not counted toward a newly discovered source minimum

### Blockers

- `blocked_auth`: Classical Echos OAuth token is expired or revoked.
- `blocked_auth`: Trapiistan/Sosai OAuth token is expired or revoked.
- No registered, verified fareed320 failover token was found.
- `blocked_discovery`: The watchlist seeder uses Classical Echos OAuth, so latest-source discovery could not run.
- No NASA, space, unknown, filler, or unrelated old clips were substituted.
...
https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=jVKmrOx3kuVdJvXpQqy03q0uBOR7sP&code_challenge=dGaq5f7H7Tx4sp9yhBqiSGgZXVSHm_8JFRCTb8qgR-s&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=trapiistan%40gmail.com
