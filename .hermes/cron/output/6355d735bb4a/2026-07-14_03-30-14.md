...
- Metrics monitor:
  - Ran successfully.
  - Live metrics unavailable because both YouTube OAuth tokens are revoked/expired:
    - Classical Echos: `invalid_grant`
    - Trapiistan/Sosai: `invalid_grant`

- Upload queue first:
  - Starting queue_count: `0`
  - Ending queue_count: `1`
  - Queued rendered clip:
    - `UPLOAD_QUEUE/chris-williamson-why-the-ai-doomers-might-be-right-03-daily.mp4`

- Source attempted:
  - Creator: Chris Williamson
  - Source: `Why The AI Doomers Might Be Right - Robert Wright`
  - Original URL: `https://www.youtube.com/watch?v=TNCZJTduDpQ`
  - Uploaded_count: `0/5`
  - Rendered_count: `1`
  - Public URLs: none
...
- Blockers:
  ...
  - Auth healthcheck also shows both upload tokens are revoked/expired with `invalid_grant`.
  - Because only 1 rendered clip exists and 0 uploaded, this is not OK.
  - Remaining 4/5 deficit is backlog, not success.

- Queue status:
  - `queue_count: 1`
  - The failed rendered clip was preserved for retry.
