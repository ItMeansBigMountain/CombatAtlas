...
The U.S. stock market is closed today, Friday 2026-07-03, for Independence Day observed. Robinhood quotes were stale from the 2026-07-02 close, so policy gates did **not** permit order review or placement. Existing deployment is already within the 70%–90% target range, and no stale-data thesis breach required an exit.
...
| Symbol | Qty | Avg Cost | Last Regular Trade | Est. Value | Est. P/L |
|---|---:|---:|---:|---:|---:|
| SOFI | 4.47758 | $17.87 | $18.26 | ~$81.76 | +$1.75 |
| AMD | 0.115059 | $521.47 | $518.26 | ~$59.63 | -$0.37 |

# Technical Read

- **SPY:** Still constructive; above 10/20-day averages, but below recent 20-day high.
- **QQQ / XLK / SMH:** Tech and semis were weaker into the latest completed session. QQQ below 10/20-day averages; SMH below 10/20-day averages with high ATR and elevated volume.
- **XLF:** Relative strength; near 20-day high with above-average volume.
- **SOFI:** Above 10/20-day averages, constructive short-term trend, but near resistance around the recent 20-day high near $19.19.
- **AMD:** Near 20-day average but below 10-day average; high volatility with ATR around 7.1%. Semiconductor sector backdrop remains pressured.

# Fundamental / News / Sector Read

- **SOFI:** Recent context shows Q2 2026 earnings call scheduled. Q1 adjusted net revenue was reported around $1.087B, up ~41% YoY, but full-year guidance was reportedly held unchanged, creating mixed sentiment. Financial sector strength is supportive, but SOFI remains volatile.
- **AMD:** AI/data-center demand remains the core bull driver. Recent searched context indicated Q1 2026 beat and Q2 revenue guidance around $11.2B versus expectations, but the broader semiconductor group has been under pressure from AI valuation and chip-sector rotation concerns.
- **Sector flow:** Financials looked stronger than tech/semis in the latest completed session. Semis, including AMD/NVDA/AVGO/SMH, showed weakness.

# Action Taken

- Managed existing positions only.
- No exit, trim, add, or new entry.
- No `review_equity_order` call made because market was closed and live/fresh quote state was unavailable.
...
`/opt/data/HeRmEz/projects/trading-journal/2026-07-03/midday-monitor.md`
