...
# Midday Decision — Hold All / No Orders
...
- **Today’s fills:** None
- **Kill switches:** Clear; account value is above $10, and broker/account state was verified
- **Current deployment:** **98.15% equities / 1.85% cash**

The available-liquid-balance target was **$4.97 deployable / $1.24 reserve**. No deployment was made because the account already holds five equities, planned risk is near the default limit, and no confirmed add or rotation justified forcing a roughly $5 order.

## Holdings and Decisions

| Holding | Price | Unrealized | Score | Decision |
|---|---:|---:|---:|---|
| **SHOP** | $152.73 | +$7.45 / +6.00% | 14/16 | **Hold**; strongest holding. Stop $143.50; targets $160/$165. |
| **BAC** | $63.91 | +$1.87 / +2.88% | 13/16 | **Hold** near resistance. Stop $61.40; targets $64.80/$66. |
| **NESR** | $35.42 | +$1.23 / +4.96% | 12/16 | **Hold with active profit watch**. Target $36.60/$38; invalidation $31.85. |
| **AVGO** | $419.45 | +$0.78 / +1.99% | 11/16 | **Hold**, but semiconductor breadth remains mixed. Stop $410; targets $440/$455. |
| **MA** | $565.97 | -$0.74 / -1.14% | 10/16 | **Hold, weakest/first rotation candidate**. Exit on decisive $550 failure. |

No stops were widened, and no losing position was added to. Estimated entry-to-stop aggregate risk remains approximately **$5.33**, near the default $6 guide.

## Market Regime

**Mixed/rotation ahead of Wednesday CPI.**

- SPY remained above rising 20- and 50-day averages but traded below midday VWAP.
- QQQ was soft and only marginally above its 50-day average.
- IWM remained comparatively firm.
- **Energy led**, with XLE +1.31%.
- Industrials were also strong; technology was comparatively flat.
- CPI on August 12 creates material overnight event risk.

## Ranked Opportunities

1. **XOM — 13/16:** Best fresh setup, but extended above its prior 20-day closing high. Wait for the planned **$157–$158 retest/reclaim**; do not chase.
2. **RTX — 13/16:** Strong industrial trend and diversification value. Needs a sustained break and retest above approximately **$225.70**.
3. **CRWD — 12/16:** Powerful momentum, but extended and below midday VWAP. Preferred **$214–$216 retest** never occurred.
4. **UBER — 11/16:** Constructive trend and cash-flow thesis, offset by regulatory/deal risks. Now beyond the preferred **$75–$76** entry area.
5. **CRWV — 8/16:** Rejected due to negative 60-day momentum, position below SMA50, event uncertainty, and weak intraday confirmation.
...
- **New fills:** None
- **Next priorities:** NESR at $36.60, BAC at $64.80, SHOP at $160, MA relative strength/$550, AVGO $410, and overnight CPI-risk management during power hour.

Journal saved to:

`/opt/data/HeRmEz/projects/trading-journal/2026-08-11/midday-decision.md`
