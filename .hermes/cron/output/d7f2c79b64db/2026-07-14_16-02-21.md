...
- NVDA: 0.121165 sh @ $206.33 avg; quote $208.82; value ~$25.30; P/L +$0.30 / +1.21%. Hold. Watch $203/$200 support and ~$198 original thesis invalidation; targets ~$214 then ~$224 if QQQ/SMH confirm.
- SOFI: 4.47758 sh @ $17.87 avg; quote $18.425; value ~$82.50; P/L +$2.49 / +3.11%. Hold. Still above $18.05–$18.10 support; watch $19.20 then $19.70–$19.75. No add because it is already the largest position.
- AVGO: 0.137376 sh @ $400.36 avg; quote $394.09; value ~$54.14; P/L -$0.86 / -1.57%. Hold, no add. It reclaimed short SMAs but remains below cost and below the $400–$402 pivot; risk areas $383–$384 then ~$372.

# Technical Read

- SPY: $750.70, +0.20%, above SMA10/SMA20; broad tape constructive but not aggressive.
- QQQ: $719.25, +1.06%, near but still below SMA10/SMA20; tech bounce improving but not fully repaired.
- IWM: $294.56, +0.37%, below SMA10/SMA20; small caps lag.
- XLK: +1.19%; SMH: +2.67%; XLF: +0.37%; XLY: -0.41%. Rotation favors tech/semis over consumer discretionary.
- Notable movers: AMD +4.88% and RKLB +4.56% are strong but extended/volatile; NVDA +2.60% and AVGO +2.61% support current semi exposure; SOFI +1.63% supports holding fintech exposure.

# Fundamental / News / Sector Read

- Semiconductor/AI context remains supportive longer-term, with continued AI infrastructure capex themes around NVDA, AMD, and AVGO. But yesterday’s chip/AI weakness and oil/Hormuz macro headlines keep reversal risk elevated.
- SOFI context is mixed-positive: recent results/news context points to execution, product expansion, Goldman Sachs target increase to $21, and Q2 earnings due July 29, but prior guidance disappointment and valuation/earnings risk argue against adding here.
- Sector cash-flow read: money appears to be rotating into semis/large-cap tech intraday, while small caps and consumer discretionary are not confirming as strongly.

# Action Taken

No order reviewed and no order placed. Management action: hold NVDA, SOFI, and AVGO; preserve $31.70 cash for buffers/exits or a cleaner later setup.
