...
**Snapshot:** July 17, 2026, 16:13 UTC / 12:13 ET  
**Actions:** No orders reviewed, placed, canceled, or rotated.

## Current State

- **Account value:** $185.52
- **Equities:** $102.17
- **Cash / liquid buying power:** $83.35
- **Pending/open-order commitment:** $0
- **Current deployment:** 55.07%
- **Open-ish orders:** None in `new`, `queued`, `confirmed`, `unconfirmed`, or `partially_filled`
- **Latest fill:** July 16 AVGO exit; no new fills today
- **Options, crypto, futures:** $0

### Deployment calculation

- 80% of available liquid balance: **$66.68**
- Required 20% cash reserve: **$16.67**
- Actual cash retained: **$83.35**

The deployment target was not forced because no fresh candidate passed the clean-entry, invalidation, and minimum 1.5:1 reward/risk gates.
...
- **Average:** $206.33
- **Live:** $204.86
- **Value:** approximately $24.82
- **Unrealized:** approximately -$0.18 / -0.71%
- **Day:** -1.22%
- **Bid/ask:** $204.87 / $204.90

NVDA recovered from the morning selloff and remains above the $201–$202 reassessment zone, but it continues to lag in a weak semiconductor tape. Long-term AI infrastructure and data-center fundamentals remain constructive; near-term valuation, positioning, AI-capex durability, and sector-flow risks prevent an add.

**Risk control:** A sustained renewed loss of approximately $198 would raise exit priority. No averaging down and no wider stop.

### SOFI — Hold, no add

- **Position:** 4.477580 shares
- **Average:** $17.87
- **Live:** $17.2701
- **Value:** approximately $77.32
- **Unrealized:** approximately -$2.69 / -3.36%
- **Day:** -0.29%
- **Bid/ask:** $17.27 / $17.28

SOFI reclaimed $17 after its morning breach, but remains below its previously calculated 10- and 20-day averages. Revenue, EBITDA, and GAAP-income growth support the longer thesis; Tech Platform weakness and July 29 earnings risk argue against adding.

**Risk control:** Sustained loss of $16.70, particularly a break below the $16.47 session low, requires exit review. No averaging down.
...
The market recovered substantially from its opening lows but remained broadly risk-off. Nasdaq, semiconductors, and discretionary stocks continued to show outflows, while healthcare supplied the clearest defensive relative strength.

## Ranked Opportunities

1. **UNH (+1.79%)** — Defensive strength and constructive earnings context, but still below the planned $437.50 breakout trigger. No chase.
2. **ABT (+1.46%)** — Strong earnings, raised EPS guidance, and healthcare inflows; price faded from its $102.13 post-earnings high, leaving an unattractive midday entry.
3. **RKLB (+3.33%)** — Best raw relative strength, but extended after a sharp move in a negative tape; catalyst confirmation and entry structure were insufficient.
4. **AMD (+0.36%)** — Relative semiconductor strength, but the broader SMH trend remained negative and the setup lacked a favorable nearby invalidation.
5. **NVDA/SOFI** — Existing positions improved intraday, but neither trend repaired enough to justify additional exposure.

## Kill Switches

- Account value below $10: **No**
- Daily loss of 5% or more: **No**
- Open-order or broker-state uncertainty: **No**
- Risk calculation unavailable: **No**
- Clean new setup available: **No — therefore no new entry**

The account was approximately **1.11% above the opening snapshot**, so the daily drawdown pause was not triggered.

Journal updated at:

`projects/trading-journal/2026-07-17/midday-monitor-1600UTC.md`
