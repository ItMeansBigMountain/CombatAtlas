...
- **Account value:** $326.77
- **Equities:** $256.98
- **Buying power / cash:** $69.79
- **Unsettled funds:** $0
- **Current equity deployment:** 78.64%
- **Cash:** 21.36%
- **Open-ish equity orders:** None across `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`
- **New fills since August 19:** None
- **Kill switch:** Clear; account value is well above $10
- No options, shorts, pending deposits, or other accounts were traded.

## Market Regime

**Mixed/rotation with risk-averse midday action.**

At approximately 16:01 UTC:
...
SPY and IWM remain above their 20- and 50-day averages, but all three benchmarks were below intraday VWAP. QQQ was also slightly below its 50-day average. This did not support chasing high-gap movers.
...
- **Price:** $578.54
- **Value:** $65.69
- **Unrealized:** +$0.69 / **+1.06%**
- Above SMA20 **$564.03** and SMA50 **$534.28**
- 20-/60-day momentum: **+7.85% / +15.08%**
- Above intraday VWAP and outperforming SPY
- Targets: **$583.70**, then **$601.77**
- Invalidation: daily loss of approximately **$564**, or a decisive break below $571.80 with continued sector weakness
- Q2 revenue was $9.277B; net margin improved to 47.3%; EPS of $5.04 beat $4.76

**Strongest holding.**

### 2. BAC — Hold, Weakest Holding, 11/16

- **Shares:** 1.046363
- **Average cost:** $62.12
- **Price:** $62.56
- **Value:** $65.46
- **Unrealized:** +$0.46 / **+0.71%**
- Prior close was near SMA20 **$63.01** and above SMA50 **$60.23**
- 20-/60-day momentum: **+2.52% / +21.95%**
- Below intraday VWAP, with only modest XLF support
- Targets: **$65.23**, then breakout continuation
- Warning below **$62**; thesis invalidation near **$60.70**
- Q2 revenue was $31.558B; EPS of $1.21 beat $1.11

**First rotation/exit candidate if sector-relative strength deteriorates.**
...
- **Price:** $146.04
- **Value:** $125.90
- **Unrealized:** +$1.68 / **+1.35%**
- Above SMA20 **$137.39** and SMA50 **$125.02**
- 20-/60-day momentum: **+23.78% / +42.31%**
- Recovered above intraday VWAP after touching $144.12
- Targets: **$158.87**, then **$182.19**
- Warning below **$144.12**; thesis invalidation near **$137.40**
- Q2 EPS of $0.42 beat $0.37 and revenue reached $3.583B, although valuation remains elevated

No position was averaged down, and no stop was widened.

## Ranked Fresh Opportunities

1. **TEM — 11/16, watch:** +9.6% on more than twice typical volume. Loss-making and extended; require a verified catalyst and consolidation/retest around $64–65.
2. **MRVI — 10/16, watch:** +15.0% on strong relative volume and a new 52-week high. Loss-making biotech; require direct catalyst confirmation and a successful $7.80–8.00 retest.
3. **MARA — 9/16, no trade:** Liquid but loss-making, crypto-correlated, and below the policy score threshold.
4. **SCSC — 9/16, no trade:** Strong gap but sub-policy average liquidity and a substantial fade from the session high.
5. **SCTX — 7/16, no trade:** Thin clinical-stage biotech with a wide spread and no verified catalyst.

Several other Daily Movers were rejected for negative gap structure, low liquidity, wide spreads, sub-$5 prices, or speculative headline risk.

## Capital Deployment

- **Available liquid balance after pending orders:** $69.79
- **80% qualifying deployment amount:** $55.83
- **Required 20% reserve:** $13.96
- **Reserve untouched:** Yes

Although $55.83 was theoretically deployable, no candidate qualified for a full-policy entry with a confirmed retest, verified catalyst, clear stop, and sufficient reward-to-risk. Deploying merely to hit the target would violate the no-forced-trades rule.

## Actions

**No orders reviewed, placed, canceled, or exited.** Existing theses remain valid, while no materially superior setup justified rotation during the weak/mixed midday tape.

Journal saved to:

`projects/trading-journal/2026-08-20/MIDDAY-decision.md`
