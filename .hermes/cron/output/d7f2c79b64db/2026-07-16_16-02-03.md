...
- **Account value:** **$188.08**
- **Cash / buying power:** **$31.70**
- **Equity value:** **$156.38**
- **Deployment:** **83.15%**, within the 70%–90% target
- **Open orders:** None across `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`
- **Order IDs this run:** None

## Positions

| Symbol | Quantity | Price | Value | Unrealized P/L | Action |
|---|---:|---:|---:|---:|---|
| NVDA | 0.121165 | $207.71 | $25.17 | +$0.17 (+0.67%) | Hold; no semiconductor add |
| SOFI | 4.477580 | $17.605 | $78.83 | -$1.19 (-1.48%) | Hold/watch |
| AVGO | 0.137376 | $381.245 | $52.37 | -$2.63 (-4.77%) | Hold/watch closely; do not average down |

## Technical Read

The market is rotating away from technology and semiconductors:

- SPY -0.20%, but still above its 10- and 20-day averages
- QQQ -1.11%, below both short averages
- XLK -2.05%
- SMH -3.22%, below its short averages and prior 20-session closing low
- IWM +0.26%, XLF +0.19%, and XLY +0.68% show relative strength outside technology

Most required candidates were weak: AMD -4.31%, SMCI -6.19%, HIMS -7.10%, RKLB -11.67%, HOOD -4.18%, and RBLX -2.75%. PLTR showed relative strength but would add growth exposure when deployment is already adequate.

## Fundamental / News / Sector Read

Long-term AI-infrastructure demand continues to support NVDA and AVGO, but today’s semiconductor outflow and elevated expectation risk argue against adding. SOFI retains constructive growth, deposit, and profitability themes, but near-term earnings risk and weakness below short moving averages favor holding rather than increasing the portfolio’s largest position.

No fresh candidate had sufficient alignment among technical confirmation, catalyst quality, sector flow, portfolio fit, and at least 1.5:1 risk/reward.

## Action

**No order reviewed or placed.** Deployment is already appropriate, no position breached its written invalidation or approximately -8% review threshold, and retaining $31.70 as a broker/opportunity buffer is preferable to forcing another entry.

Key monitoring levels:

- **AVGO:** $378–$380 stabilization; stronger exit review below $370
- **NVDA:** reassess on decisive loss of $201–$202
- **SOFI:** reassess below $17.50; deeper invalidation around $16.70–$17.00

**Journal:** `/opt/data/HeRmEz/projects/trading-journal/2026-07-16/midday-monitor-1600UTC.md`
