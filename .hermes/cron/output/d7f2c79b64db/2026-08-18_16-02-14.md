...
**Scan time:** August 18, 2026, 12:00 ET

## Current State

- **Account value:** $329.01
- **Equities:** $259.22
- **Cash/buying power:** $69.79
- **Current deployment:** **78.79%**
- **Cash reserve:** **21.21%**
- **Pending-order commitments:** $0
- **Open-ish equity orders:** None across `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`
- **Today’s fills:** None returned
- **Latest fill:** AVGO sale of 0.095750 shares at $393.5001 on August 17
- **Kill switch:** Not triggered; account is active, accessible, and above $10
- **Estimated aggregate stop risk:** Approximately **$4.26**, within the roughly $6 policy target

## Market Regime

**Mixed/risk-off intraday with sector rotation:**
...
The major indexes remained above their daily SMA20/SMA50 at the prior close, so this is not yet a confirmed intermediate downtrend. However, technology weakness makes midday a poor environment for marginal long entries or chasing gap movers.

## Holdings

| Holding | Position | Noon price | Unrealized | Decision |
|---|---:|---:|---:|---|
| **MA** | 0.113541 shares | $574.48 | +$0.23 / +0.35% | **Hold — 13/16** |
| **BAC** | 1.046363 shares | $63.735 | +$1.69 / +2.60% | **Hold — 12/16; weakest holding** |
| **SHOP** | 0.862075 shares | $147.67 | +$3.09 / +2.48% | **Hold — 12/16** |

### MA

Strongest holding today: up roughly 2.2% and trading near its session high despite index weakness.

- SMA20: $560.14; SMA50: $530.86
- Q2 revenue: $9.277B
- Q2 net income: $4.388B
- EPS: $5.04 versus $4.76 estimate
- **Invalidation:** Close below $559
- **Targets:** $584, then $601
- No add while extended intraday.

### BAC

Longer-term trend and financial-sector backdrop remain positive, although the stock faded from its morning high.

- SMA20: $62.78; SMA50: $59.83
- Q2 revenue: $31.558B
- Q2 net income: $9.074B
- EPS: $1.21 versus $1.11 estimate
- **Invalidation:** $62.45
- **Targets:** $65.20, then $68
- No add near resistance without renewed intraday strength.

### SHOP

Post-earnings trend remains intact, but momentum cooled today amid growth/technology weakness.

- SMA20: $134.80; SMA50: $123.56
- 20-day return: +19.42%
- Q2 revenue: $3.583B, approximately 34% year-over-year growth
- EPS: $0.42 versus $0.37 broker estimate
- **Invalidation:** $142.75
- **Targets:** $158.85, then $170
- Hold, but do not add during the current fade.

## Ranked Fresh Opportunities

1. **HAE — 11/16, watch:** +16.2% at a new 52-week high with strong volume. Profitable medical-products company, but too extended. Require a confirmed retest around $102–$103 and catalyst verification.
2. **AMLX — 10/16, watch:** +49.4% on exceptional volume. Binary, loss-making biotechnology setup and far beyond support; no chase.
3. **WEAV — 10/16, watch:** +31.6% on approximately 19 times normal volume. Event-style repricing and loss-making fundamentals; require catalyst verification and a retest.
4. **DUOT — 9/16, no trade:** Volume-confirmed gain, but small-cap volatility and unclear daily invalidation.
5. **FLXS — 9/16, no trade:** Profitable, but average volume and spread fail preferred liquidity standards.

## Deployment and Action

- Mechanical 80% of remaining liquid buying power: **$55.83**
- Mechanical 20% reserve: **$13.96**
- Actual portfolio deployment is already **78.79%**, with a **21.21% cash reserve**

**No order was previewed or placed.** Spending another 80% of remaining cash would recursively consume the reserve and push total deployment well beyond the intended account-level 80/20 posture. Existing holdings remain valid, and none of today’s gap movers offers a sufficiently clean, confirmed, and materially superior risk-adjusted setup.

Journal saved to:

`projects/trading-journal/2026-08-18/MIDDAY-decision.md`
