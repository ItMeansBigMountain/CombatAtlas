...
# Midday Decision — Hold; No New Trades

**Account:** Robinhood Agentic ••••1041 only  
**Scan time:** August 19, 2026, approximately 12:02 PM ET

## Current State

- **Account value:** $329.18
- **Equities:** $259.39
...
- **Kill switches:** Clear; account value is above $10 and broker/account data is internally consistent
- **Existing equity deployment:** **78.80%**
- **Cash:** **21.20%**

For the current liquid balance, the policy allocation is **$55.83 deployable / $13.96 reserved**. The deployable portion was not spent because no fresh setup passed the non-extension and confirmed-entry gates.

## Holdings

| Holding | Price | Avg. cost | P&L | Decision | Score |
|---|---:|---:|---:|---|---:|
| **MA** | $577.84 | $572.48 | +0.94% | Hold | 13/16 |
| **SHOP** | $148.06 | $144.09 | +2.75% | Hold | 13/16 |
| **BAC** | $63.26 | $62.12 | +1.83% | Hold; weakest | 11/16 |

### MA
Above rising SMA20/SMA50 with positive 20- and 60-day relative strength. Q2 revenue was $9.277B, net income $4.388B, and EPS beat estimates. Intraday strength faded from $582.93, but the swing thesis remains valid.

- **Support:** $570–574
- **Management stop:** $564
- **Targets:** $594, then $602

### SHOP
Strongest held momentum: prior-close data showed +19.1% over 20 days and +39.8% over 60 days. Q2 EPS beat estimates, and the stock remains above its rising SMA20/SMA50. Valuation is elevated, so trend discipline is important.

- **Support:** $145.90, then $142
- **Management stop:** $140
- **Targets:** $158.87, then $166

### BAC
Longer-term structure and Q2 fundamentals remain constructive, but BAC underperformed the flat financial sector intraday and is the weakest holding.

- **Support:** $63.00–$62.90
- **Management stop:** $61.90
- **Targets:** $65.23, then $67
- Reassess promptly on a decisive break below $62.90 without recovery.

## Market Regime

**Mixed/rotation**, not broad risk-on:
...
SPY and IWM remain above their SMA20/SMA50. QQQ is above its SMA20 but slightly below its SMA50. The backdrop supports selective longs and confirmed retests—not chasing large gaps.

## Ranked Fresh Opportunities

1. **EL — 11/16, watch for retest**  
   Up 16.6% after earnings with exceptional volume, but approximately 5.6 ATR above its prior SMA20. Wait for consolidation or a controlled $94–96 retest.

2. **TEM — 10/16, watch for retest**  
   Up 20.1% with more than twice normal full-day volume by midday. Intraday structure improved, but the company remains unprofitable and the entry is extended. Preferred retest zone: $55–57.

3. **TWST — 10/16, watch**  
   Raised revenue guidance, 23% year-over-year revenue growth, and strong momentum. However, the stock is extremely extended and faded from $141.10. Wait for a $128–132 base or retest.

4. **MRNA — 9/16, no trade**  
   The late-stage melanoma-vaccine success is a material verified catalyst, but a 127% intraday gain and $114–$163 range create unacceptable chase and reversal risk.

5. **BNTX — 9/16, no trade**  
   Strong sympathy/catalyst move but unprofitable and fading from the session high; no clean entry.

MRVI and DNA were rejected for speculative quality, weaker daily structures, and inadequate direct catalyst confirmation.

## Actions

- **Held MA, SHOP, and BAC**
- **No additions, exits, trims, or rotations**
- **No averaging down or widened stops**
- **No orders reviewed or placed** because no candidate qualified before broker review
- Preserved the **$13.96 mandatory reserve** and left the remaining liquid balance idle rather than force an extended entry

Journal saved to:

`projects/trading-journal/2026-08-19/MIDDAY-decision.md`
