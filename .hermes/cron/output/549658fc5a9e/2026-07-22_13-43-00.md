...
# OPEN Scan Decision — HOLD / NO TRADE

**Scan:** July 22, 2026, 09:30–09:40 ET  
**Account operated:** Robinhood Agentic **433711041 / ending 1041 only**

## Live Account State

- Account value: **$186.75**
- Equity positions: **$183.42**
- Buying power/cash: **$3.33**
...
- Daily change: approximately **-0.86%**, inside the -5% pause threshold
- Drawdown from journal high-water value: approximately **-8.07%**, inside the -10% pause threshold
- Aggregate marked downside to current invalidations: approximately **$4.74**

## Current Positions

| Symbol | Value | Unrealized P&L | Management level | Targets | Decision |
|---|---:|---:|---:|---:|---|
| NVDA | $25.04 | +$0.04 | Invalidate below $198 | $214 / $220 | Hold |
| SOFI | $77.37 | -$2.64 | Exit review on sustained loss of $16.90 | $18.60 / $19.74 | Hold; monitor closely |
| JPM | $67.36 | +$0.68 | Invalidate below $337 | $351.24 / $360 | Hold |
| UNH | $13.54 | +$0.20 | Invalidate below $423 | $450 / $461.62 | Hold |

No invalidation or target fired. SOFI remains the first exit-review candidate if **$16.90** fails. Stops remain management triggers rather than resting broker orders.
...
The opening was mixed and defensive. Materials, energy, utilities, and staples led; technology and semiconductors lagged. QQQ remained below important short/intermediate moving averages.

Macro and event risks include tariff- and energy-related inflation pressure, oil/Iran exposure, the July 28–29 FOMC meeting, and major after-close earnings from GOOGL/GOOG, TSLA, IBM, TXN, and NOW.

## Ranked Candidates

1. **T — 7.3/10:** Prefer a $22.90–$23.05 retest that holds; invalidation $22.25; targets $24.29/$25.
2. **PHM — 7.0/10:** Prefer support at $126–$127 or reclaim of $129.30; invalidation $124; targets $129.30/$140.09.
3. **BLFS — 6.8/10:** Require breakout/retest above $31.50; invalidation $29.65.
4. **ARWR — 6.2/10:** Extended by roughly 19%; require a multi-session base near $84–$87.
5. **SMCI — 5.8/10:** High-volatility gap in an unrepaired longer trend; require a $28.50–$29 retest.

None qualified for an opening entry without chasing.

## Deployment and Actions

- Available liquid buying power: **$3.33**
- Mechanical 80% deployment amount: **$2.66**
- Nominal 20% reserve: **$0.67**
- Cash deployed this scan: **$0**
- Cash retained: **$3.33**
- Existing account deployment: **98.22%**

The account already holds the policy maximum of four positions, planned risk is near the soft cap, and the remaining $3.33 is the retained reserve from the prior deployment—not a fresh tranche to spend recursively.

**No order was reviewed or placed. No position was sold, averaged down, or rotated.** There was no sufficiently clean setup or materially superior replacement to justify churn.

Journal saved at:

`/opt/data/HeRmEz/projects/trading-journal/2026-07-22/OPEN-agentic-scan.md`
