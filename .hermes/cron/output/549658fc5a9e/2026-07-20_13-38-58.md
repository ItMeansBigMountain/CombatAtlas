...
# OPEN Scan Decision — No New Trade

## Live Agentic Account ••••1041

- **Account value:** $185.58
- **Equities:** $102.23
- **Cash / liquid buying power:** $83.35
- **Pending/open orders:** None across `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`
- **Recent fills since July 17:** None
- **Kill switch:** Not triggered; account and broker state verified

### Positions

| Position | Live price | Value | Unrealized | Action |
|---|---:|---:|---:|---|
| NVDA 0.121165 sh @ $206.33 | $207.60 | $25.15 | +$0.15 / +0.62% | Hold |
| SOFI 4.477580 sh @ $17.87 | $17.17 | $76.88 | -$3.13 / -3.92% | Hold; close watch |

## Deployment Decision

- Available liquid balance: **$83.35**
- Policy deployment target: **$66.68**
- Required cash reserve: **$16.67**
- Existing equity deployment: approximately **55.1% of account value**
- Estimated risk to practical NVDA/SOFI invalidation levels: approximately **$5.29**, already near the default $6 aggregate-risk ceiling

No candidate supported investing another $66.68 without exceeding aggregate risk or chasing an opening gap. Cash was retained rather than forcing a trade.

## Market Regime

Opening action was risk-on but not yet a confirmed trend repair:
...
Semiconductors led sharply, while financials, energy, healthcare, and staples lagged. QQQ entered the session below its 10-, 20-, and 50-day averages following last week’s chip-sector decline. The first several minutes of the rebound were therefore treated as a potential retest—not chased.

## Ranked Candidates

1. **NVDA — 8.0/10, hold only**
   - Above 20-day average but below 50-day resistance
   - Targets: $214, then $220–225
   - Review on loss of $199–202; hard invalidation near $189.80

2. **PLTR — 7.2/10, watch**
   - Stronger structure than most growth peers
   - Trigger: successful $131.50–133 retest or acceptance above $139
   - Invalidation: approximately $125
   - Targets: $145 and $152

3. **AMD — 7.0/10, wait for retest**
   - +4.94% opening gap but still below its 10/20-day averages
   - Trigger: reclaim and hold $530–533
   - Invalidation: below $495
   - Targets: $560 and $584
   - Current stop distance is too large for sandbox risk limits

4. **AVGO — 6.8/10, watch**
   - Testing its 20-day average after a +3.15% gap
   - Trigger: $378–382 retest holds
   - Invalidation: below $370
   - Targets: $403 and $415

5. **HOOD — 6.1/10, watch**
   - Above its 50-day average but below 10/20-day resistance
   - Invalidation: below $92.80
   - Targets: $107 and $112

Robinhood Daily Movers was also inspected. The list was dominated by ADRs, smaller special situations, and technically damaged names; none met the combined liquidity, catalyst, structure, and risk requirements.

## Exact Actions

- **NVDA:** Held; no add
- **SOFI:** Held; no add. Reassess or exit if $16.47–16.70 fails. Recovery targets are $17.90 and $19.20–19.74.
- **Orders reviewed:** None
- **Orders placed/cancelled:** None
- **Fills:** None
- **Cash deployed:** $0
- **Cash retained:** $83.35
- **Tool failures:** None; current web-news sourcing was mixed quality, so live broker data received greater weight

Journal saved to `projects/trading-journal/2026-07-20/open-scan-1337UTC.md`.
