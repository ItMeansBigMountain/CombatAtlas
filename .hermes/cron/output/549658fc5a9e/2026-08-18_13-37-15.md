...
- Account value: **$328.08**
- Equity value: **$258.29**
- Cash / buying power: **$69.79**
- Unsettled funds: **$0**
- Pending/open equity orders: **None**
  - Checked `new`, `queued`, `confirmed`, `unconfirmed`, and `partially_filled`
- Latest fill: **Sold 0.095750 AVGO at $393.5001** on August 17
- Kill switch below $10: **Not triggered**
- Pending-order commitments: **$0**

Liquid-balance allocation:

- 80% deployable target: **$55.83**
- 20% required cash reserve: **$13.96**

The portfolio endpoint did not provide enough history to conclusively verify the daily/recent-high drawdown gates. No new exposure was added.

## Market Regime

**Mixed/rotation with a risk-off opening impulse.**

At approximately 9:35 a.m. ET:
...
The intermediate index trend remained constructive, but the opening tape showed sharp technology weakness and rotation toward energy, health care, staples, and financials. Firmer oil/yields, rising volatility from low levels, retailer earnings, and upcoming Fed minutes supported waiting for price discovery rather than chasing opening moves.

## Position Decisions

| Position | Live value | Unrealized P/L | Decision | Invalidation / targets |
|---|---:|---:|---|---|
| **BAC** | $67.30 | **+$2.30 / +3.54%** | Hold; strongest holding | Review exit below $62.70; targets $65.20 and $67 |
| **SHOP** | $127.50 | **+$3.28 / +2.64%** | Hold | Review exit below $142; targets $155 and $158.50 |
| **MA** | $64.17 | **-$0.83 / -1.28%** | Hold on close watch; weakest holding | Review exit below $556; needs recovery through $570–576 |

Indicative risk to these management levels is approximately **$7.82**, already above the normal **$6 aggregate-risk target**. That was a binding reason not to add exposure. These are monitoring levels; no protective broker orders were placed during this scan.

## Ranked Fresh Candidates

1. **XOM — 12/16, watch/reduced starter only**  
   Strong energy-relative momentum, +8.83% over 20 genuine sessions, improving Q2 revenue and profitability, and support from higher oil/geopolitical risk. It opened near or above recent resistance, making an immediate entry extended.  
   **Preferred trigger:** retest and hold $161–162  
   **Invalidation:** $157.50  
   **Targets:** $168 / $172

2. **JPM — 12/16, watch**  
   +6.52% over 20 sessions and +19.53% over 60, above rising 20/50-day averages, with financial-sector strength. It remains near $366.50 resistance.  
   **Trigger:** hold $360–362 or confirmed breakout/retest above $366.50  
   **Invalidation:** $355  
   **Targets:** $373 / $380

3. **LLY — 12/16, watch**  
   Strong Q2 earnings and revenue beat, raised sales guidance, positive 60-day momentum, and health-care leadership. It has not yet cleared nearby resistance.  
   **Trigger:** sustained move above $1,210 followed by a retest, or support near $1,180  
   **Invalidation:** $1,145  
   **Targets:** $1,249 / $1,300

4. **CRWD — 11/16, watch**  
   +31.61% over 60 sessions, rising averages, and improving profitability, but technology was the weakest opening sector and $227.50 remains resistance.  
   **Trigger:** confirmed breakout and retest  
   **Invalidation:** $205  
   **Targets:** $235 / $245

5. **UBER — 10/16, reduced-size watch**  
   Improving Q2 profitability and positive 20-day momentum, offset by weak 60-day relative strength and acquisition/autonomous-vehicle uncertainty.  
   **Trigger:** breakout and retest above $79  
   **Invalidation:** $74  
   **Targets:** $86 / $90

## Exact Action

**No orders reviewed, placed, canceled, or filled during this scan.**

The opening tape was only five minutes old, the strongest candidates were extended or lacked confirmed retests, and existing planned portfolio risk was already above the normal aggregate target.

- Cash deployed: **$0**
- Buying power retained: **$69.79**
- Required reserve retained: **$13.96**
- Unspent deployable tranche: **$55.83**

The decision and data limitations were journaled at:

`projects/trading-journal/2026-08-18/OPEN-scan-decision.md`
