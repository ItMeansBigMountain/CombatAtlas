...
# OPEN Scan Decision — July 23, 2026

## Exact Action

**Exited the entire SOFI position after its written $16.90 invalidation failed.**

- Sold: **4.477580 SOFI**
- Order: Market sell, regular hours
- Fill: **$16.7500**
- Proceeds: approximately **$75.00**
- Fees: **$0**
- Realized price loss versus $17.87 average cost: approximately **$5.01 (-6.27%)**
- Order ID: `6a621912-1a9f-45bb-8ee8-7b5d32b73a1b`
- Review checks: No broker alerts
- Compliance quote: **Bid $16.77 × 1600 Q · Ask $16.78 × 1200 Q · Last $16.76 × 1000 Q. Updated 9:37 AM ET.**

The order was verified filled, SOFI disappeared from positions, and all open-ish order states were empty afterward.

## Live Account State

- Account: Agentic **433711041 / ending 1041 only**
- Final account value: **$185.19**
- Remaining equity value: **$106.86**
- Cash: **$78.33**
- Authoritative buying power: **$3.33**
- Pending orders: **$0**
- Remaining positions:
  - NVDA 0.121165 shares
  - JPM 0.195159 shares
  - UNH 0.031089 shares
- Kill switches: Clear
- Drawdown versus $200 funding proxy: approximately **7.41%**, below the 10% pause threshold

Although the sale proceeds appeared in cash, broker buying power remained only $3.33, likely reflecting cash-account settlement constraints. I treated the broker’s buying-power field as authoritative and did not redeploy unavailable funds.

## Market Regime

Risk-off/mixed opening:

- SPY: **-0.85%**
- QQQ: **-1.40%**
- IWM: **-0.60%**
- Leaders: XLI +1.65%, XLE +1.59%, XLV +0.90%
- Laggards: XLY -3.29%, XLC -2.39%, SMH -1.13%

Technology and consumer sectors weakened following major earnings dispersion, while energy, industrials, and healthcare attracted relative strength.

## Position Management

- **NVDA:** Hold; $198 invalidation, $214/$220 targets. No add near SMA50/resistance while semiconductors lag.
- **JPM:** Hold; $337 invalidation, $351.24/$360 targets. Strong trend but near resistance.
- **UNH:** Hold; $423 invalidation, $450/$461.62 targets. Healthcare relative strength remains constructive.
- **SOFI:** Thesis invalidated and position closed. No averaging down or stop widening.

## Ranked New Candidates

1. **RTX — 7.4/10:** Strong industrial breakout, but the +7.4% opening gap was extended. Prefer a $203.90–$205 retest; invalidation $199; targets $214/$220.
2. **TMO — 7.2/10:** Strong healthcare trend, but +9.3% and more than two ATR above prior resistance. Prefer a $545–$555 base; invalidation $535.
3. **CSX — 7.0/10:** Constructive breakout with industrial-sector support. Prefer a $51.20–$51.60 retest; invalidation $49.80; targets $54.50/$56.
4. **CLF — 6.5/10:** Liquid +17.3% gap but still near declining SMA50. Requires a multi-session base above $10.50.
5. **IMAX — 6.3/10:** Improving trend but extended and below $45.52 resistance. Prefer a $41–$42 hold.

No candidate offered a clean, non-chasing opening entry with at least 1.5:1 reward/risk.

## Deployment

- Equity deployment after exit: **57.70%**
- Available liquid buying power: **$3.33**
- Mechanical 80% deployable amount: **$2.66**
- Mechanical reserve: **$0.67**
- New cash deployed: **$0**

No new order was placed because buying power had not updated and the qualifying candidates required pullbacks/retests. Forcing an immaterial $2.66 position would have violated setup-quality discipline.

Journal saved to:

`projects/trading-journal/2026-07-23/OPEN-agentic-scan.md`
