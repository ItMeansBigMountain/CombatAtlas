...
**Job ID:** 6355d735bb4a
**Run Time:** 2026-06-26 13:59:08
**Mode:** no_agent (script)

---

New creator video(s) found for Viral Radar:
- My Best Hiding Spot So Far...
  https://www.youtube.com/shorts/t4bOQq_mMAg
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-26-zerkaaplays-my-best-hiding-spot-so-far-t4bOQq_mMAg
- How to succeed in your 7 personal year cycles (and how most people fail)
  https://www.youtube.com/shorts/fYybqRF-ZMQ
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-26-gg33-how-to-succeed-in-your-7-personal-year-cycles-and-how-most-fYybqRF-ZMQ
...
Daily Viral Radar: blocked_provider / blocked_source
...
- Upload URL: none. No upload happened.

Blockers:
- Metrics ran, but live stats were unavailable.
...
- Candidate refresh failed with the same revoked/expired Google OAuth token.
- Source download failed.
  - YouTube blocked yt-dlp with bot/sign-in verification.
  - Log path: `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/RbYILvKalxs`
- Opus fallback is not configured.
  - Missing: `OPUS_CLIP_API_KEY`
  - Also missing: Choppity, Vizard, Klap, MuAPI keys.

Cleanup:
- No generated media uploaded.
- Nothing cleaned up beyond normal script temp handling.
