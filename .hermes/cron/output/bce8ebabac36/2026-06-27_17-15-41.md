...
- There Was An Attempt...
  https://www.youtube.com/shorts/BKR5zPhivPg
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-27-zerkaaplays-there-was-an-attempt-BKR5zPhivPg
...
Starting clip/render/upload pipeline for newly discovered Viral Radar item(s)...
{
  ...
  "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-06-27/RbYILvKalxs-viral-radar.json",
...
Daily Viral Radar: blocked, no upload.

- Selected source: GG33 — “Dating in 2026 is a Scam”
- Hook: “Dating in 2026 feels rigged”
- Source URL: https://www.youtube.com/shorts/RbYILvKalxs
- Upload: none

Exact blockers:
- Google/YouTube API queue refresh failed:
  - `invalid_grant: Token has been expired or revoked`
- Metrics monitor ran, but same token issue hit:
...
- Nothing deleted.
- Manifest preserved:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-20-gg33-dating-in-2026-is-a-scam-RbYILvKalxs/clip_manifest.json`

Needed fix:
- Refresh the YouTube OAuth token.
- Add YouTube cookies/proxy/local MP4 source, or configure Opus/provider credentials.
