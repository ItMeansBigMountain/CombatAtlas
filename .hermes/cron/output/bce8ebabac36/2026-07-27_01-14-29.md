...
- **Public URLs:** None
- **Upload queue:** `0`
- **Selected/rendered sources:** None
- **Metrics:** Monitor completed, but fetched `0` live statistics across 383 logged IDs because the Classical Echos token is revoked/expired.
- **Run artifact:** `OUTPUTS/strict-viral-radar-run-2026-07-27T011313Z.json`
- **Raw log:** `OUTPUTS/strict-cron-logs/2026-07-27T010301Z-daily-upload.log`

### Exact blockers

- Classical Echos OAuth: `invalid_grant`
- Trapiistan/Sosai OAuth: `invalid_grant`
- Fareed320 also returned `invalid_grant` during the preceding live fallback probe.
- `viral_radar_daily_upload.py` produced no output and timed out after 600 seconds.
- The queue is empty because no clip was selected/rendered—not because the 5-clip requirement was completed. There were no failed rendered uploads eligible for queueing.

```text
[Command timed out after 600s]
application log size: 0 bytes
```

### Required recovery

Authorize each expected account, then return the **full localhost callback URL** with its corresponding prefix.

**Classical Echos (`classicalechos@gmail.com`):**  
<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=SKrPgLhdPTRjWq88aDx4NdWZiR8gIJ&code_challenge=e0ie7RSGlZ6_G5E90IGFfpxI3hCafnUatHwNrrbZgOg&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=classicalechos%40gmail.com>

`youtube:classicalechos: <full localhost callback URL>`

**Trapiistan/Sosai (`trapiistan@gmail.com`):**  
<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=Var18KzPjG5zePfmNO8UficI4lFfMH&code_challenge=_ELSXUgHmV7wfIotkm04vBjKazmcoesK2yCzvfK_ZB4&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=trapiistan%40gmail.com>

`youtube:trapiistan: <full localhost callback URL>`

**Fareed320 (`fareed320@gmail.com`):**  
<https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=984335329962-jmsnmsu79o45n751hdguq832dqool860.apps.googleusercontent.com&redirect_uri=http%3A%2F%2Flocalhost%3A1%2F&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.upload+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.force-ssl+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyoutube.readonly+https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fyt-analytics.readonly&state=wOh9cKKxAkf3D3H2ifsdF5aDNpcVzO&code_challenge=GzD-FpzDjZzlhTx-LETaKuTAiKRDfCIAkiojBEsspnw&code_challenge_method=S256&access_type=offline&include_granted_scopes=false&prompt=consent&login_hint=fareed320%40gmail.com>

`youtube:fareed320: <full localhost callback URL>`

After token exchange and channel verification, replay the strict source-specific procedure to reach at least `5/5`.
