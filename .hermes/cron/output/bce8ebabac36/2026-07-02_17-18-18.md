...
```
{
  ...
  "marker": "/opt/data/HeRmEz/projects/viral-clip-radar/STATE/viral_radar_daily_upload_2026-07-02.done",
...
- Candidate refresh: OK.
  ...
  - Included Huberman, Chris Williamson, Kinobody, Cobratate/Tate, GG33, Nate Belmar, Hormozi, Hamza, Hamza Unfiltered.
  - Skipped:
    - TateSpeech: YouTube playlist not found.
    - Luke Belmar: no recent long-form found.
    - Capital Club: YouTube playlist not found.

- Upload attempt: blocked. No video uploaded.
  - Tried 8 manifests.
  - All source downloads failed on YouTube bot/cloud-IP checks.
  - Main error: `Sign in to confirm you’re not a bot`
  - pytubefix/pytube fallback also failed with `HTTP Error 400`.
...
- Opus Clips fallback:
  - Not configured.
  - Env check: no Opus API keys present.
  - Pipeline says Opus is intentionally disabled.
