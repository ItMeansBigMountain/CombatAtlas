...
**Job ID:** 6355d735bb4a
**Run Time:** 2026-06-23 13:47:01
**Mode:** no_agent (script)

---

New creator video(s) found for Viral Radar:
- The Most Sus Hiding Spot...
  https://www.youtube.com/shorts/RnTey4ltVQk
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-23-zerkaaplays-the-most-sus-hiding-spot-RnTey4ltVQk
...
- Status: `blocked_source` / `needs_provider_credentials`
...
- Upload: none. No render/upload completed.

Blockers:
- YouTube API refresh failed during queue seed:
  - `invalid_grant: Token has been expired or revoked`
- Metrics monitor also hit revoked token:
