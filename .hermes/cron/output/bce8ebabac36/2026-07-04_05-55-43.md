...
stdout:
{
  ...
  "seed_result": {
    ...
    "seeded": [
      ...
      },
      {
        ...
        "title": "The Type of P*rn Women Actually Prefer",
        "duration_seconds": 569,
        "url": "https://www.youtube.com/watch?v=F7EICO5PXzU",
        "plan": "/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-07-03-chris-williamson-the-type-of-p-rn-women-actually-prefer-F7EICO5PXzU"
      },
      {
  ...
  "source_failures": [
    ...
    {
      "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-07-04/andrew-huberman-movement-practice-to-strengthen-yo-01.json",
    ...
    {
      "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-07-04/andrew-huberman-essentials-the-science-of-eating-f-01.json",
    ...
    {
      "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-07-04/andrew-huberman-improve-flexibility-with-research-01.json",
    ...
    {
      "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-07-04/cobratate-andrew-tat-my-data-041013-5-0020-01.json",
    ...
    {
      "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-07-04/hamza-everyone-called-me-crazy-6-01.json",
...
- Viral Radar run: `blocked_source_all_candidates`
- Upload: none. No source media could be downloaded, so no render/upload happened.
- Metrics monitor: ok. OAuth metrics active. `148` stats fetched from `191` seen videos.
- Queue refresh: ok. Seeded `9` creator long-form candidates.
- Attempted candidates: `8`
- Main blocker: YouTube cloud-IP/bot check.
  - `yt-dlp`: “Sign in to confirm you’re not a bot”
  - `pytubefix`: HTTP 400
  - `pytube`: HTTP 400
- Selected/attempted hooks included:
  - Andrew Huberman: “the part people will replay”
  - Andrew Tate: “the part people will replay”
  - Cobratate / Andrew Tate: “the part people will replay”
  - Hamza: “the part people will replay”
- Example exact log paths:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/O-groYMqrQw`
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/Zz8chJwh3S4`
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/6l7I-eFxG4A`
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/2xUiBnse4x0`
- Opus Clips fallback creds: not configured.
  - `OPUSCLIP_API_KEY`: missing
  - `OPUS_CLIPS_API_KEY`: missing
  - `OPUS_PRO_API_KEY`: missing
  - `OPUS_KEY`: missing
- Cleanup: no generated upload media to clean. Manifests/logs preserved.
- Next fix needed: add YouTube cookies, a residential proxy, or local/direct MP4 source for one queued creator video.
