...
- Science of Attraction, Compatibility & Romance | Dr. Paul Eastwick
  https://www.youtube.com/watch?v=CV0GtUlJ6NM
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-22-andrew-huberman-science-of-attraction-compatibility-romance-dr-paul-eastwi-CV0GtUlJ6NM
...
- Upload: no upload happened.

Blockers:
- YouTube source download failed:
  - `yt-dlp` hit YouTube bot/sign-in verification.
  - Log path: `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/RbYILvKalxs`
- Opus/provider fallback is not configured:
  - Missing `OPUS_CLIP_API_KEY`
  - Also missing Choppity, Vizard, Klap, MuAPI keys.
- Candidate refresh also failed:
  - Google/YouTube token expired/revoked: `invalid_grant`
- Metrics monitor ran, but live stats were unavailable:
  - `/opt/data/secrets/youtube-trapiistan/youtube_upload_token.json` is expired/revoked.

Cleanup:
- No generated media was uploaded.
