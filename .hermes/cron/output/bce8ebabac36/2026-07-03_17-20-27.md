...
Viral Radar 12:15 CT run: `blocked_source_all_candidates`

- Metrics: ok
  - OAuth metrics worked.
  - 190 videos seen.
  - 147 stats fetched.
  - Learnings file updated/read path: `/opt/data/HeRmEz/projects/_ops/social-growth/PERFORMANCE_LEARNINGS.md`

- Candidate refresh: ok
  - Seeded 9 fresh long-form manifests.
  - Creators included: Huberman, Chris Williamson, Kinobody/Greg, Cobratate, GG33, Nate Belmar, Hormozi, Hamza, Hamza Unfiltered.
  - Skipped:
    - TateSpeech: YouTube playlist 404.
    - Luke Belmar: no recent long-form found.
    - Capital Club/Luke Belmar: YouTube playlist 404.

- Upload/render: blocked before render.
  - Tried 8 source candidates.
  - All failed at source download.
  - Main blocker: YouTube bot check / cloud-IP auth.
  - yt-dlp error: `Sign in to confirm you’re not a bot. Use --cookies-from-browser or --cookies`
  - pytubefix + pytube also failed with `HTTP Error 400`.

- Example selected hooks/candidates:
...
- Exact log paths:
  ...
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/WWe4up63hb4`
  - `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/syJYZm5OZhE`
...
- Opus Clips fallback: not configured / intentionally disabled.
  - Pipeline says Opus is disabled by policy.
  - No Opus fallback was used.

- Upload URL: none.
  - No source media downloaded.
  - No render happened.
  - No cleanup needed beyond temp manifests.
