...
- Essentials: The Science of Eating for Health, Fat Loss & Lean Muscle | Dr. Layne Norton
  https://www.youtube.com/watch?v=WWe4up63hb4
...
- This Hiding Spot Almost Worked...
  https://www.youtube.com/shorts/takV8syNyZI
  Plan: /opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-25-zerkaaplays-this-hiding-spot-almost-worked-takV8syNyZI
...
Starting clip/render/upload pipeline for newly discovered Viral Radar item(s)...
{
  ...
  "manifest": "/opt/data/HeRmEz/projects/viral-clip-radar/TMP/daily-cron-manifests/2026-06-25/RbYILvKalxs-viral-radar.json",
...
Viral Radar 12:15 CT run: blocked.

- Selected creator/source: GG33 — “Dating in 2026 is a Scam”
- Hook: “Dating in 2026 feels rigged”
- Source URL: https://www.youtube.com/shorts/RbYILvKalxs
- Upload: none. No render/upload happened.

Exact blockers:
- Metrics OAuth: `/opt/data/secrets/youtube-trapiistan/youtube_upload_token.json` is expired/revoked.
- Queue refresh failed: Google/YouTube API token `invalid_grant: Token has been expired or revoked`.
- Source download failed: YouTube bot check blocked `yt-dlp`.
- Download log: `/opt/data/HeRmEz/projects/viral-clip-radar/LOGS/daily_youtube_source_download/RbYILvKalxs`
- Opus fallback: not configured.
- Other clipping providers missing too: Choppity, Vizard, Klap, MuAPI.

Cleanup:
- No generated media to clean.
- Manifests/logs preserved.

Fix needed:
- Refresh the Classical Echos/YouTube OAuth token.
