...
```
{
  ...
  "marker": "/opt/data/HeRmEz/projects/viral-clip-radar/STATE/viral_radar_daily_upload_2026-06-29.done",
...
- Metrics monitor: `ok`
  ...
  - 157 videos seen.
  - 114 stats fetched.
  - Learnings file updated/read: `/opt/data/HeRmEz/projects/_ops/social-growth/PERFORMANCE_LEARNINGS.md`

- Candidate refresh: `ok`
  - Seeded 9 fresh creator candidates.
  - TateSpeech + Capital Club playlist IDs still 404.
  - Luke Belmar had no recent long-form found.

- Selected creator/source:
  - Andrew Huberman
  - Plan: `/opt/data/HeRmEz/projects/viral-clip-radar/CLIP_PLANS/2026-06-04-huberman-motivation-great-find/clip_manifest.json`

- Hook:
  - “Craving is part pleasure, part pain — and pain eventually wins.”

- Upload:
  - Public YouTube Short uploaded.
  - URL: https://youtu.be/YyyLqrFo97Y
  - Video ID: `YyyLqrFo97Y`

- Cleanup:
  - Rendered export deleted after verified upload:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/EXPORTS/huberman-great-find/craving-is-pain-in-disguise-daily.mp4`
  - Source video safely deleted:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/SOURCES/huberman-motivation-great-find/vA50EK70whE.mp4`

- Notes:
  - Earlier run today hit YouTube bot-check source blocking on the new Huberman source.
  - This run used `FORCE_UPLOAD=1` because the daily marker already existed, then successfully uploaded from an available reviewed/source-ready fallback.
