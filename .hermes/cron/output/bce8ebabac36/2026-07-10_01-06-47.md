...
4. **Upload at a tested viral window**
   - Use Central Time for the user's Texas/US audience until analytics prove otherwise.
   - YouTube Shorts default test windows: **2–4 PM CT** and **8–10 PM CT**.
   - TikTok/Reels references if cross-posting later: TikTok **7–9 PM weekdays**; 
...
Viral Radar strict run result: `blocked_upload_quota`

- Metrics monitor: OK
  - OAuth metrics working.
  - 397 video IDs seen.
  - 304 stats fetched.
  - Current Viral Radar winners still favor Alex Hormozi / Luke Belmar / GG33 style hooks.

- Ran:
  - `FORCE_UPLOAD=1`
  - `VIRAL_RADAR_UPLOAD_QUEUE_FIRST=1`
  - `VIRAL_RADAR_MIN_UPLOADS=100`
  - `VIRAL_RADAR_DAILY_UPLOAD_CAP=100`
  - `/opt/data/scripts/viral_radar_daily_upload.py`

- Uploaded this run:
  - “This Sounds Wrong Until It Clicks”
    - https://youtu.be/pxSvGD3VlRg
  - “The Part They Say Quietly”
    - https://youtu.be/6cFgP7kYyAI
  - “Why This Hits Harder Than Expected”
    - https://youtu.be/trySp6_pkeY
  - “The Uncomfortable Truth Hiding Here”
    - https://youtu.be/W_u_5bU7Mag

- Source used:
  - Chris Williamson — “Everything You Learned In School Is A Lie”
  - Original source:
    - https://www.youtube.com/watch?v=tK1ctEZjF4w

- Queue status:
  - Active `UPLOAD_QUEUE`: 1 rendered clip + metadata queued.
  - `UPLOAD_QUEUE_HOLD`: 1 older Alex Hormozi rendered clip + metadata still held.
  - Total remaining queued rendered clips found: 2.

- Newly queued failure:
  - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/chris-williamson-everything-you-learned-in-school-is-a-lie-topup-auto-10-captioned-daily.mp4`
  - Metadata:
    - `/opt/data/HeRmEz/projects/viral-clip-radar/UPLOAD_QUEUE/chris-williamson-everything-you-learned-in-school-is-a-lie-topup-auto-10-captioned-daily.mp4.upload.json`

- Blocker:
  - YouTube upload quota hit.
  - First failure:
    - `429 rateLimitExceeded`
    - `Quota exceeded for quota metric 'Video Uploads' and limit 'Video Uploads per day'`
  - Then account-level upload cap:
    - `400 uploadLimitExceeded`
    - `The user has exceeded the number of videos they may upload.`

- No filler/placeholder sources were used.
- Failed rendered clip was preserved and queued for next run.
