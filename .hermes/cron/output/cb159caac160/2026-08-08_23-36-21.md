# Cron Job: Monitor Who's Grinding Plugin Hub PR

**Job ID:** cb159caac160
**Run Time:** 2026-08-08 23:36:21
**Schedule:** every 120m
...
Monitor RuneLite Plugin Hub PR https://github.com/runelite/plugin-hub/pull/13917 for Who's Grinding Panel. It must remain a single-plugin submission changing only plugins/whos-grinding-panel and point to ItMeansBigMountain/whos-grinding-clan-panel-osrs commit 78a545e88b2414622cd4d1a0b4655fc81d0bca33 unless an intentional newer tested child revision is published. Inspect issue comments, formal reviews, inline comments, merge/closed state, changed files, and check runs. Treat a red aggregate check titled 'Requires maintainer review' as the expected human-review gate, not a defect. Build failures or 'Changes are needed' are actionable. If there is no new actionable feedback and the build remains healthy, send nothing. If merged, report success and recommend moving the project from pr-review-pending to completed; do not create another PR or schedule jobs recursively.

## Response

PR #13917 required corrective action and has been repaired.

- **State:** Open, not merged or closed
- **Submission scope:** Exactly one changed file: `plugins/whos-grinding-panel`
- **Issue found:** The live marker still referenced obsolete child commit `d55e711779e06a7fdfe29a661c6aaca92d25030e`
- **Fix pushed:** Plugin Hub commit `ed60d50cce377a0dadb518cb13f39e343a76e377`
- **Current child revision:** `78a545e88b2414622cd4d1a0b4655fc81d0bca33`
- **Build:** Passed
- **RuneLite Plugin Hub Checks:** Red only for **“Requires maintainer review”**, the expected human-review gate
- **Feedback:** No formal reviews or inline comments; no new actionable maintainer feedback

The PR is now healthy and awaiting maintainer review.
