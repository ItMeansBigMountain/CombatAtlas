...
**Scan time:** July 20, 2026, 3:32 PM ET

## Live Account State

- **Total value:** $183.81
- **Equities:** $167.14 — 90.93% deployed
- **Cash / liquid buying power:** $16.67 — 9.07% reserve
- **Open-ish orders checked:** new, queued, confirmed, unconfirmed, partially filled — **none**
- **Kill switches:** Clear
  - Account value above $10
  - Approximate unrealized loss: **$4.57**
  - Account approximately 8.1% below the original $200 funding proxy
  - Current-price risk to written invalidations: approximately **$4.23**, within the ~$6 aggregate target

## Actions and Fills

- **New orders reviewed:** None
- **New orders placed or cancelled:** None
- **New fills during this scan:** None
- Today’s verified fill remains:
  - **JPM buy:** $66.68
  - **0.195159 shares at $341.6699**
  - Order `6a5e2855-17cf-4546-937b-b6a129da1933`
...
- **0.121165 shares**
- Quote: **$203.03**
- Position value: approximately **$24.60**
- Below intraday VWAP and SMA10, but holding near/above SMA20 support.
- **Invalidation:** decisive break below **$198.50**
- **Targets:** $213.90, then $220
- Next verified earnings: **August 26**
- No averaging down.
...
- **4.477580 shares**
- Quote: **$17.095**
- Position value: approximately **$76.54**
- Below SMA10/SMA20 and intraday VWAP, but today’s $16.9705 low did not break the established swing invalidation.
- **Exit review:** below **$16.45**
- **Targets:** $18.50, then $19.70
- Verified earnings: **July 29 before market**
- Earnings-gap risk and weak relative strength require close monitoring; likely reassess/de-risk before the event absent recovery.
- No averaging down.
...
- **0.195159 shares**
- Quote: **$338.08**
- Position value: approximately **$65.98**
- Near SMA10 and still above rising SMA20/SMA50 support.
- **Exit review:** below **$334**
- **Targets:** $351, then $360
- Recent Q2 EPS of $6.14 beat the $5.59 estimate; financial-sector daily structure remains constructive despite today’s weakness.
- No add below entry.

## Market and Rotation Assessment

SPY, QQQ, and IWM faded below intraday VWAPs, with SPY and QQQ below key daily moving averages. Semiconductor and technology rebounds lacked broad confirmation; financials retained the cleanest daily sector structure.

Broad scans covered **297 daily gainers** and **331 upcoming-earnings equities**. ACHR, IREN, and CIFR were extended 18%–19% countertrend gaps; CLS remained below its major moving averages ahead of July 27 earnings. None offered a materially better, non-chasing setup with clean 1.5:1+ reward/risk. Rotating into them would increase volatility and constitute churn.

## Deployment

- Available liquid balance: **$16.67**
- Policy deployment target if qualified: **$13.336**
- Policy liquid reserve: **$3.334**
- **Deployed this scan:** $0
- **Cash retained:** $16.67

The 80% liquid-balance target was overridden by the no-forced-trade gate. No existing thesis reached invalidation, and no materially superior setup justified overnight rotation.

Journal written to:

`projects/trading-journal/2026-07-20/power-hour-scan-1932UTC.md`
