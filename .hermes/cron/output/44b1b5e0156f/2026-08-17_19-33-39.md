...
**Scan time:** 2026-08-17 19:32 UTC / 3:32 PM ET  
**Actions:** No orders reviewed, placed, or cancelled. No new fills during this scan.

## Account and Risk State

- **Account value:** $329.68
- **Equity exposure:** $259.89 — **78.83% invested**
- **Cash:** $69.79 — **21.17% reserve**
...
- **Kill switches:** Clear; account is above $10 and available evidence does not trigger the daily or recent-high drawdown pauses
- **Today’s fill:** AVGO sell **0.095750 shares at $393.5001**, filled 13:37:43 UTC, $0 fees

## Overnight Positions

| Rank | Position | Mark / P&L | Decision | Binding invalidation | Targets |
|---|---|---:|---|---:|---:|
| 1 | **BAC** 1.046363 @ $62.12 | $64.13 / **+$2.10 (+3.24%)** | Hold; strongest, no add at resistance | **$61.40** | $66 / $68 |
| 2 | **SHOP** 0.862075 @ $144.09 | $149.47 / **+$4.64 (+3.73%)** | Hold/protect; no add | **$143.50** | $160 / $166 |
| 3 | **MA** 0.113541 @ $572.48 | $562.24 / **-$1.16 (-1.79%)** | Hold; weakest | **$550** | $583.70 / $596 |

Aggregate mark-to-stop risk is approximately **$9.39**, above the default $6 target. No additional risk was added, no stops were widened, and no averaging down occurred. These are scan-managed invalidations rather than resting broker orders.

## Market and Candidate Assessment

The regime remains **mixed/rotation within a rising medium-term trend**:

- SPY -0.43%, QQQ -0.14%, IWM -0.48%
- All remain above completed-bar SMA20/SMA50
- XLK showed relative strength, while XLF weakened
- Major indexes faded during power hour, reducing the case for another overnight long

Fresh candidates:

1. **NVDA — 12/16, watch:** Strong trend and quality, but near its 20-day high with verified August 26 earnings risk. Wait for a $220–223 retest or post-earnings confirmation.
2. **AXTI — 11/16, watch:** Valid catalyst, but still extended after an approximately 18% one-day move. Require a $90–92 retest.
3. **ARGX — 10/16, watch:** Profitable and liquid, but a vertical first-day gap without sufficient catalyst confirmation.
4. **AVGO — 9/16, no re-entry:** Below SMA20 with negative 60-day momentum and September 2 earnings risk. The morning exit remains justified.

## Deployment

- Qualifying deployment target from settled buying power: **$25.69**
- Required settled reserve: **$6.42**
- **Deployed this scan:** $0
- Existing portfolio exposure is already near 80%, and no fresh candidate reached the 13+ threshold with a confirmed entry. Spending the available balance would have forced a marginal fourth position.

**Final overnight posture:** Hold BAC, SHOP, and MA with unchanged invalidations. No rotation or new entry was sufficiently better on a risk-adjusted basis.

Journal saved to:

`projects/trading-journal/2026-08-17/POWER-HOUR-agentic-scan.md`

Limited margin would allow the Agentic account to reuse unsettled sale proceeds without borrowing or leverage:
