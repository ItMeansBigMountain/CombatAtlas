...
```
# Google Workspace morning context — Tuesday, 2026-06-16 08:30 AM CDT
...
- Gmail profile: fareed320@gmail.com | messages: 714 | threads: 682
...
- Email priority/cleanup buckets for report:
  ...
  - interesting/source for report: 16
    - From: TLDR InfoSec <dan@tldrnewsletter.com> | Subject: Europe Council Hack 🇪🇺, M365 Copilot Leak 💻, Hand Gestures for ReCAPTCHA 👋
    - From: TLDR IT <dan@tldrnewsletter.com> | Subject: VPN flaws under active attack 🛡️, AI ops risks hit production 🤖, Agent governance gets real 🧑⚖️
    - From: TLDR Crypto <dan@tldrnewsletter.com> | Subject: World Cup prediction markets 📊, SpaceX IPO frenzy 💸, EUR Stablecoins hit ATH 🚀
    - From: TLDR Dev <dan@tldrnewsletter.com> | Subject: AI needs more dev discipline 💪, Component Party 🎉, job offer backdoor 🥷
    - From: TLDR Marketing <dan@tldrnewsletter.com> | Subject: AI search manipulation 👀, llms.txt study 🧪, YouTube keyword opps 📈
    - From: TLDR <dan@tldrnewsletter.com> | Subject: Anthropic's superpower 🤖, Roku acquired 💰, agentic code review 👨💻
  - light review: 2
    - From: "H&M" <membership@email.hm.com> | Subject: Retro sports looks
    - From: YouTube <no-reply@youtube.com> | Subject: Video is blocked in some territories: oPeNcLaW sucks
- Unread recent:
  - From: TLDR InfoSec <dan@tldrnewsletter.com> | Subject: Europe Council Hack 🇪🇺, M365 Copilot Leak 💻, Hand Gestures for ReCAPTCHA 👋 | Snippet: The ShinyHunters ransomware gang claims to have hacked Europe&#39;s leading human rights organization, the Council of Europe
  - From: "H&M" <membership@email.hm.com> | Subject: Retro sports looks | Snippet: Polos, graphic T-shirts &amp; matching sets.
  - From: TLDR IT <dan@tldrnewsletter.com> | Subject: VPN flaws under active attack 🛡️, AI ops risks hit production 🤖, Agent governance gets real 🧑⚖️ | Snippet: Palo Alto Networks (Unit 42) has confirmed active exploitation of a GlobalProtect VPN vulnerability, CVE-2026-0257, on PAN-OS devices
  - From: TLDR Crypto <dan@tldrnewsletter.com> | Subject: World Cup prediction markets 📊, SpaceX IPO frenzy 💸, EUR Stablecoins hit ATH 🚀 | Snippet: Bernstein projects Robinhood&#39;s prediction market revenue will reach $586 million in 2026, up from $150 million in 2025.
  - From: TLDR Dev <dan@tldrnewsletter.com> | Subject: AI needs more dev discipline 💪, Component Party 🎉, job offer backdoor 🥷 | Snippet: Since AI makes generating code fast and disposable, we&#39;re shifting from obsessing over individual lines of code to managing entire systems instead
  - From: TLDR Marketing <dan@tldrnewsletter.com> | Subject: AI search manipulation 👀, llms.txt study 🧪, YouTube keyword opps 📈 | Snippet: AI search and deep research tools can be influenced by extremely small pieces of UGC on sites like Reddit, Wikipedia, and Quora
  - From: TLDR <dan@tldrnewsletter.com> | Subject: Anthropic's superpower 🤖, Roku acquired 💰, agentic code review 👨💻 | Snippet: Many people think that Anthropic&#39;s public statements around its model releases are mostly scare-mongering for the sake of marketing
  - From: Daily Stoic <info@dailystoic.com> | Subject: This Is Poverty That’s Your Fault | Snippet: There is the form of poverty that is not having enough. This is a real and tragic problem...
- Recent inbox sample:
  - From: TLDR InfoSec <dan@tldrnewsletter.com> | Subject: Europe Council Hack 🇪🇺, M365 Copilot Leak 💻, Hand Gestures for ReCAPTCHA 👋
  - From: "H&M" <membership@email.hm.com> | Subject: Retro sports looks
  - From: TLDR IT <dan@tldrnewsletter.com> | Subject: VPN flaws under active attack 🛡️, AI ops risks hit production 🤖, Agent governance gets real 🧑⚖️
...
```json
{
  "command": "python3 /opt/data/scripts/google_morning_context.py",
  "background": true,
