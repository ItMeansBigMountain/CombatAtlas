...
```
# Google Workspace morning context — Monday, 2026-07-06 08:30 AM CDT
...
- Gmail profile: affan.fareed@gmail.com | messages: 1076 | threads: 904
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-06T13%3A30%3A58.783587Z&timeMax=2026-07-13T13%3A30%3A58.783587Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">

### personal-secondary — fareed320@gmail.com
- Role: personal secondary — read-focused; no sends without approval
- Gmail profile: fareed320@gmail.com | messages: 754 | threads: 722
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-06T13%3A31%3A00.425330Z&timeMax=2026-07-13T13%3A31%3A00.425330Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">
...
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-06T13%3A31%3A01.097130Z&timeMax=2026-07-13T13%3A31%3A01.097130Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">

### burner — laflametoast@gmail.com
- Role: burner / low-stakes misc
- Gmail profile: laflametoast@gmail.com | messages: 80 | threads: 70
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-06T13%3A31%3A01.932111Z&timeMax=2026-07-13T13%3A31%3A01.932111Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">
```
...
**Top line**
- Google morning context ran, but signal is thin today
  - No high-signal email/calendar items were surfaced by the collector
  - Main issue: Google auth/scope blockers are preventing full Calendar coverage

**Work source / operating pulse**
- **Google Workspace pulse**
  - `trapiistan / Hermes operator`
    - Blocked: token refresh failed with `invalid_scope`
    - Action: needs OAuth repair before operator/YouTube Workspace context is reliable
  - `personal-main`, `personal-secondary`, `classicalechos`, `burner`
    - Gmail profile checks succeeded
    - Calendar reads failed with insufficient scopes
    - Action: Workspace tokens need Calendar scope reauth if you still want weekly calendar pulled into the morning report
  - No Drive/Docs/Sheets movement was included in today’s pre-run context

**Email priority + cleanup**
- **Priority emails**
  - None surfaced in the pre-run data
  - No visible Chase / Apple / billing / GitGuardian / Ticketmaster / myQ / official notice signal today

- **Interesting/source emails**
  - None surfaced today
  - TLDR/Kino/Daily Stoic/Grammarly items were not included in the collected context

- **Cleanup actions**
  - Already-approved junk categories remain safe cleanup candidates when found:
    - FoundersCard
    - Yieldi
    - Crunch
    - Higgsfield
...
- **Needs review**
  - Newsletter/source emails should still be reviewed before deletion unless already used in the video pipeline and upload was verified

**Calendar / prep notes**
- Calendar collection is currently blocked across personal/content/burner accounts by missing scopes
  - If there’s anything time-sensitive today, it was not visible to the report
  - Fix: reauth the affected Google profiles with Calendar scope

**Chicago local pulse**
- Current Chicago readout:
  - ~72°F, partly cloudy
  - Feels like ~76°F
  - NNE wind around 11 mph
  - Low rain chance shown in the weather result
- Good outside/work block weather
  - Not a “hide indoors all day” signal

**Market pulse**
- Market source results were weak/stale today
  - No clean live futures snapshot came through
  - Treat markets as “check manually before trading,” not “morning-report confirmed”

**AI + coding news**
- Source-backed broad theme only:
  - AI coding remains the active battleground
  - Recent coverage continues framing Anthropic/OpenAI as strong in coding agents while Google/Microsoft push to catch up
- Practical read:
  - Keep using coding-agent workflows where they produce actual shipped artifacts
  - Don’t chase tool discourse unless it changes your current build/release loop

**Numerology**
- 2026-07-06 → `2+0+2+6+0+7+0+6 = 23 → 5`
  - “5” day: movement, cleanup, unblock stuck lanes
  - Best use: fix auth, clear one operational bottleneck, then ship

**Daily challenge**
- Repair one blocked system lane today
  - Best target: Google OAuth/scopes
  - Outcome: tomorrow’s report gets real calendar/email signal instead of auth errors

**One big priority prompt**
- What is the single operator lane that becomes easier if Google context is reliable again?
  - Morning report?
  - YouTube/content automation?
  - Personal admin?
  - Pick that lane first, then reauth only what supports it.

**Hard truth / leverage move**
- The report cannot be “smart” if the collectors are blind.
  - Today’s leverage move is not more planning.
  - It’s restoring Google auth/scope health so the daily system can see what matters before you do.
