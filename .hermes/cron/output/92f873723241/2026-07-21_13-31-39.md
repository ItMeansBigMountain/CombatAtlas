...
```
# Google Workspace morning context — Tuesday, 2026-07-21 08:30 AM CDT
...
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-21T13%3A30%3A56.489386Z&timeMax=2026-07-28T13%3A30%3A56.489386Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">
...
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-21T13%3A30%3A58.235378Z&timeMax=2026-07-28T13%3A30%3A58.235378Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">

### personal-secondary — fareed320@gmail.com
- Role: personal secondary — read-focused; no sends without approval
- Gmail profile: fareed320@gmail.com | messages: 799 | threads: 767
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-21T13%3A30%3A59.361700Z&timeMax=2026-07-28T13%3A30%3A59.361700Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">
...
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-21T13%3A31%3A00.089319Z&timeMax=2026-07-28T13%3A31%3A00.089319Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">

### burner — laflametoast@gmail.com
- Role: burner / low-stakes misc
- Gmail profile: laflametoast@gmail.com | messages: 80 | threads: 70
- ERROR: Google API error: <HttpError 403 when requesting https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=2026-07-21T13%3A31%3A00.959780Z&timeMax=2026-07-28T13%3A31%3A00.959780Z&singleEvents=true&orderBy=startTime&maxResults=12&alt=json returned "Request had insufficient authentication scopes.". Details: "[{'message': 'Insufficient Permission', 'domain': 'global', 'reason': 'insufficientPermissions'}]">
```
...
**Top line**
- Gmail access is healthy across all five Google profiles.
- Calendar visibility is blocked everywhere by missing OAuth scopes.
- Markets lean risk-on premarket, led by tech.
- Today’s leverage move: fix the shared Calendar auth gap, then return to the highest-value shipping task.
...
- **Google Workspace pulse**
  ...
  - The collector returned account totals but no message-level Gmail, Drive, Docs, or Sheets updates.
    - No specific priority email, receipt, deadline, or file movement can be responsibly surfaced.
  - Calendar failed on all five profiles.
    - Blocker: tokens lack Calendar authentication scopes.
    - Impact: today’s events and the next seven days could not be checked.

**Email priority + cleanup**
- **Priority emails**
  - No message-level priority items were included in today’s collection.
- **Interesting/source emails**
  - No TLDR, Kino Body/Kinobody, Daily Stoic, or Grammarly issue was surfaced.
- **Cleanup actions**
  - None taken.
  - No approved-junk messages were identified in the available output.
- **Needs review**
  - None identifiable without sender, subject, and unread-message data.
  - Newsletter/source mail remains untouched unless its content has been used and the resulting upload verified.

**Calendar / prep notes**
- Calendar unavailable across every profile due to insufficient OAuth scopes.
- Any appointments, deadlines, or Jared coding prep may therefore be missing from this report.

**Chicago local pulse**
- **8:30 AM:** 76°F and partly cloudy.
  - Feels near 80°F.
  - Humidity: 82%.
  - WNW wind around 12 mph, gusting near 19 mph.
  - Immediate rain chance was low at roughly 11%.
- Expect a warm day around the mid-80s; morning is the cleaner window for outdoor movement.

**Market pulse**
- Premarket futures were positive:
  - Nasdaq 100: **+1.20%**
  - S&P 500: **+0.39%**
  - Dow: **+0.27%**
- Tech is carrying the strongest early momentum.
  - Useful signal, but not a reason to chase the open.

**Google search / social pulse**
- No sufficiently strong, US-specific trend surfaced to justify a content pivot this morning.
- The available trend results were mostly international weather and football-personality searches—low relevance to current operating lanes.

**AI + coding news**
- Anthropic published a concrete Claude Code migration pattern:
  - Build a rulebook.
  - Map dependencies.
  - Stress-test translation rules before broad rollout.
- Practical takeaway:
  - For any active refactor or migration, encode decisions once and test the rules against edge cases instead of prompting file-by-file.

**Interesting item**
- “Rulebook before migration” is the most usable signal today.
  - It turns coding-agent work from improvisation into a repeatable transformation pipeline.

**Numerology**
- **Universal day: 2**
  - Coordination, patience, and closing gaps.
  - Good fit for repairing shared infrastructure and making one workflow dependable.

**Daily challenge**
- Remove one recurring blocker before noon.
  - Best candidate: restore Calendar scopes and verify each profile with a harmless live probe.

**One big priority prompt**
- **What single deliverable can be fully shipped and verified today—not merely advanced?**

**Hard truth / leverage move**
- Five connected Gmail accounts create the appearance of broad visibility, but the missing Calendar scope leaves a real blind spot.
- Repair the shared auth layer once; don’t keep tolerating partial morning reports.
