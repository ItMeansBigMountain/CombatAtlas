...
- `references/cellphone-scripts-2026-scope.md` — session-derived scope for converting a Pythonista script archive into a Pocket Toolkit.
- `references/automation-tick-pattern.md` — reusable pattern for "always running" Pythonista requests using Siri Shortcuts-triggered one-shot ticks.
